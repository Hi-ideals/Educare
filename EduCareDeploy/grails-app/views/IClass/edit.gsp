			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div id="edit-IClass" class="content scaffold-edit" role="main">
									...
									<div class="portlet-title">
										<div class="caption font-blue">
											<i class="fa fa-book font-blue"></i> <span
												class="caption-subject bold uppercase"> Edit Class</span>
										</div>

									</div>
									<div class="portlet-body form">
										<g:form url="[resource:IClassInstance, action:'update']"
											method="PUT">
											<g:hiddenField name="version"
												value="${IClassInstance?.version}" />
											<fieldset class="form">
