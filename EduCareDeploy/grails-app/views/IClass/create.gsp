		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<g:render template="/header/leftSide"
					model="[activ:[Settings:'start active open',IClass:'active']]"></g:render>
				<!-- END SIDEBAR MENU -->
				<!-- END SIDEBAR MENU -->
			</div>
			<!-- END SIDEBAR -->
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div id="create-IClass" class="content scaffold-create"
									...
									<g:hasErrors bean="${IClassInstance}">
										<ul class="errors" role="alert">
											<g:eachError bean="${IClassInstance}" var="error">
												<li
									...
									<div class="box box-info">
										<div class="portlet light bordered">
											...
											<div class="portlet-body form">
												<g:form url="[resource:IClassInstance, action:'save']">
													<fieldset class="form">
													...
													<fieldset class="buttons">
														<g:if test="${instituite == null }">
															<div style="color: red">
																<sec:username />
																Cannot add a Class Fees without an Instituite.
															</div>
