		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<g:render template="/header/leftSide"
					model="[activ:[batch:'start active open',batchcreate:'active']]"></g:render>
			</div>
		</div>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								...
								<div id="create-IClass" class="content scaffold-create"
									role="main">
										...
										<div class="portlet light bordered">
											<div class="portlet-title">
												<div class="caption font-blue">
													<i class="icon-calendar font-blue"></i> <span
												...
												<g:form url="[resource:batchInstance, action:'save']">
													...
													<fieldset class="buttons">
														<g:if test="${instituite == null }">
															<div style="color: red">
																<sec:username />
																Cannot add a Batch without an Instituite.
															</div>
