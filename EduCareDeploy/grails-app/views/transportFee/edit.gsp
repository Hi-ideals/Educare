			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><i class="fa fa-circle"></i> <g:link class="list"
								action="index">Transport Fee Lists</g:link></li>
				...
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<div id="edit-transportFee" class="content scaffold-edit"
									role="main">
									...
									<g:hasErrors bean="${transportFeeInstance}">
										<ul class="errors" role="alert">
											<g:eachError bean="${transportFeeInstance}" var="error">
												<li
									...
									<div class="portlet light bordered">
										...
										<div class="portlet-body form">
											<g:form
												url="[resource:transportFeeInstance, action:'update']"
												method="PUT">
												<g:hiddenField name="version"
													value="${transportFeeInstance?.version}" />
												<fieldset class="form">
