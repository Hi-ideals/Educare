			...
			<div class="page-content">
				...
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<h4>Edit Institute Details</h4>
								<div id="edit-instituite" class="content scaffold-edit"
									role="main">
									...
									<div class="box box-info">
										<div class="portlet light bordered">
											<g:form url="[resource:instituiteInstance, action:'update']"
												enctype='multipart/form-data'>
												<g:hiddenField name="version"
													value="${instituiteInstance?.version}" />
												<fieldset class="form">
