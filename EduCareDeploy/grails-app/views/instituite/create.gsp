						...
						<div class="row">
							<div class="col-md-12">
								...
								<div id="create-instituite" class="content scaffold-create"
									...
									<g:hasErrors bean="${instituiteInstance}">
										<ul class="errors" role="alert">
											<g:eachError bean="${instituiteInstance}" var="error">
												<li
									...
									<div class="box box-info">
										<div class="portlet light bordered">
											...
											<div class="portlet-body form">
												<g:form url="[resource:instituiteInstance, action:'save']"
...
<![endif]-->
	...
	<script>
		...
		$(document).ready(function() {
			$('#instituitecreate').click(function() {
				var input = $('#institutionPrefixName').val();
				if (input == '') {
					$('#IinstitutionPrefixName').show();
					return false;
				} else if (!input.match(/^[a-zA-Z]{3,4}$/)) {
					$('#IinstitutionPrefixName1').show();
				} else {
					$('#IinstitutionPrefixName').hide();
					$('#IinstitutionPrefixName1').hide();
				}
			});
		});
		$(document).ready(function() {
			$('[id="institutionPrefixName"]').on('change', function() {
				var input = $('#institutionPrefixName').val();
				if (input == '') {
					$('#IinstitutionPrefixName1').hide();
					$('#IinstitutionPrefixName').show();
