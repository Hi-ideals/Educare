								...
								<div class="crtfcte">
									...
									<div class="row">
										...
										<div class="certificate">
											...
											<div class="col-md-12">
												<h4>
													<b>Students attendance date : ${params?.fromDate}</b>
												</h4>
												<div class="portlet-body">
													<div class="table-scrollable">
														...
														<table class="table table-bordered">
															...
															<g:each in="${studentAttendanceList?.keySet()}" var="st1"
																status="k">
																<tr>
																	<td>
																		${st1?.studentName}
																	...
																	<g:each
																		in="${studentAttendanceList.getAt(st1).keySet() }"
																		var="att">
																		<g:if
																			test="${date.toString() == att.getDate().toString() }">
																			<td>
																				${att}
																			</td>
																			<td><g:if
																					test="${Atendancedates.getAt(att)=='P'}">
																					<h6>
																		...
																		<g:else>
																			...
																			<g:set var="date"
																				value="${Integer.parseInt(date.toString())+1 }"></g:set>
																			<td>
																				<h6>
