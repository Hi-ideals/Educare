		...
		<div class="page-content-wrapper">
			...
			<div class="page-content">
				...
				<div class="portlet light bordered">
					<div class="portlet-title">
						<div class="caption font-blue">
							<i class="icon-user font-blue"></i> <span
								class="caption-subject bold uppercase"> Create New Student Attendance</span>
						</div>
					</div>
					...
					<g:form url="[resource:studentAttendanceInstance, action:'getStudentAttendanceSheet']">
						<fieldset class="form">
						...
						<br>
							<g:submitButton name="create"  align="left|right|center|justify" class="btn btn-success btn blue"
								value="${message(code: 'default.button.Take Attendance.label', default: 'Take Attendance')}" />
						</fieldset>
					</g:form>
				</div>
			</div>	
