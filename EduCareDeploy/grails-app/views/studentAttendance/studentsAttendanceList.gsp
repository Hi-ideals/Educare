					...
					<div class="portlet light bordered">
						<div class="portlet-title">
							<div class="caption font-blue">
								<i class="icon-pin font-blue"></i> <span
									class="caption-subject bold uppercase">Student
									Attendance</span>
							</div>
						</div>
						<div id="create-studentAttendance" class="content scaffold-create"
							...
							<g:formRemote name="form"
								url="[resource:staffAttendanceInstance, action:'getStudentAttendanceDetails']"
							...
							<div id="getstudentdetails">
								<g:render template="studentsAttendanceDetails"></g:render>
							</div>
							<div id="getstudentdetails">
