	...
	<div class="page-container">
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<%--
			<g:render template="/header/leftSide" model="[activ:[superAdmin:'start active open',createAdmin:'active']]"></g:render>
			--%>
			</div>
		</div>
									...
									<div class="portlet-title">
										<div class="caption font-green">
											<i class="icon-pin font-green"></i> <span
												class="caption-subject bold uppercase"> Create Admin</span>
										</div>

									</div>
									<div class="portlet-body form">
										<g:form controller="admin" enctype='multipart/form-data'>
											<fieldset class="form">
												<g:render template="form" />
											</fieldset>
											<fieldset class="buttons" style="text-align: center">
												<g:actionSubmit action="save" value="create"
													class="btn blue" id="cash" style="display:none"
													value="${message(code: 'default.button.create.label', default: 'Create')}" />
												<g:actionSubmit action="makepayment" value="Make Payment"
													class="btn blue" id="online" style="display:none" />
											</fieldset>
										</g:form>
									</div>
								</div>
