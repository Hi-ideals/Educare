		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<g:render template="/header/leftSide"
					model="[activ:[payroll:'start active open',paySlip:'active']]"></g:render>
				<!-- END SIDEBAR MENU -->
				<!-- END SIDEBAR MENU -->
			</div>
			<!-- END SIDEBAR -->
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								...
								--%>
													<button class="btn blue" id="yearclick">
														Get Pay Slip
													</button>
													...
													<div id="academicyr" style="display: none">
														<g:formRemote name="payslip"
															url="[action:'generatepayslip']" update="update1">
															<br>
															<div class="row">
																<div class="col-md-4">
																	<label>Staff</label> <select name="staff.id" id="staff"
																	...
																	<div id="Sstaff" style="display: none; color: red;">Select
																		your Staff</div>
																</div>
																...
																<div class="col-md-4">
																	...
																	<g:select name="month" id="month" class="form-control"
																		from="${com.hiideals.institute.payroll.StaffSalary.constraints.month.inList}"
																		required="" value="${staffSalaryInstance?.month}"
																		valueMessagePrefix="staffSalary.month" />
																</div>


																<div class="col-md-4">
																	<label>Academic Year</label> <select
																...
																<div class="col-md-4">
																	<g:submitButton name="Search" class="btn blue"
																		id="staffSalary" style="margin-top: 22px" />
																</div>
															</div>
									...
									<div class="col-md-12" id="update1">
