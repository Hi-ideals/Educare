							...
							<div class="col-md-12">
										...
										<div class="box box-info">
													...
													<div class="row">
														<div class="col-md-3">
                                                         ...
                                                         <div class="col-md-3" style="visibility: hidden;">
															<label>Repeat Class<span
																class="required-indicator" style="color: red">*</span></label> <input
																name="ppclass" id="presentclass"
																class="form-control" readonly="readonly"
																value="${it?.presentclass?.id}" />
                                                        </div>
                                                    </div>
                                          ...
                                          <div class="col-md-3" style="visibility: hidden;">
                                               <label>Repeat Section</label>
															<input
																name="section" id="presentclass" 
																class="form-control" readonly="readonly" value="${it?.section?.id}" />
								...
								code="student.gender.label" default="Select Gender" /></label>-->
										...
										<fieldset class="buttons" style="margin-left: 85%">
											<g:actionSubmit value="submit" action="saverepeate"
