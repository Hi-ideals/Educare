			...
			<div class="page-content">
				...
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<h4><i class="fa fa-edit"></i> Edit Student Details</h4>
								...
								<div id="edit-student" class="content scaffold-edit" role="main">
									...
									<g:form url="[resource:studentInstance, action:'update']"
										enctype='multipart/form-data'>
										<g:hiddenField name="version"
											value="${studentInstance?.version}" />
										<fieldset class="form">
											<g:render template="form" model="[edit:'none']" />
										</fieldset>
										<fieldset class="buttons">
											<g:actionSubmit class="btn blue" action="update" id="student"
