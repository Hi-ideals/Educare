					...
					<table class="table table-bordered table-hover">
						<thead>
							<tr>
								...
								<th style="display:none">Registration Number</th>
						...
						<g:each in="${transer }" var="T">
						<tbody>
						<tr>
						<td>${T.admissionnumber }</td>
						<td>${T.stName }</td>
						<td>${T.stfatherName }</td>
						<td>${T.stClass }</td>
						<td>${T.stSection }</td>
						<td>${T.academicyear }</td>
						<td>${T.stfeePaid }</td>
						<td>${T.stadmissionDate }</td>
						<td>${T.stTcissuedate }</td>
								...
								<div style="text-align: center;">
									<ul class="pagination">
										<li><g:paginate total="${studentInstanceCount ?: 0}" /></li>
									</ul>
								</div>
							</div>
						</div>
