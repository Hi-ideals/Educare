		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<g:render template="/header/leftSide"
					model="[activ:[readminssion:'start active open',readminssion:'active']]"></g:render>
				<!-- END SIDEBAR MENU -->
				<!-- END SIDEBAR MENU -->
			</div>
			<!-- END SIDEBAR -->
								...
								<div class="box box-info">
									<div class="portlet light bordered">
										...
										<div class="portlet-body form">
											...
											<button class="btn blue margin-bottom-10" id="yearclick">
											...
											<div id="cast" style="display: none">
												<g:formRemote name="sscast" url="[action:'index']"
													update="Changedisplay">
													<div class="row">
