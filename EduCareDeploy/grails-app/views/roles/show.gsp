									...
									<div class="table-responsive">
										<table class="table table-bordered table-striped">
											<g:if test="${rolesInstance?.roleName}">
												<tr>
													...
													<td><strong><g:fieldValue
																bean="${rolesInstance}" field="roleName" /></strong></td>
												</tr>
											</g:if>
											<g:if test="${rolesInstance?.dateCreated}">
												<tr>
													<td>Date Created</td>
											...
											<tr>
												<td>Actions</td>
												<td><g:form
														url="[resource:rolesInstance, action:'delete']"
														method="DELETE">
														<fieldset class="buttons">
															<g:link class="btn btn-warning" action="edit"
																id="${LookUpED.encod(rolesInstance?.id)}">
