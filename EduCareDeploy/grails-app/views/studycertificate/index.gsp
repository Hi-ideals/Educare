		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<g:render template="/header/leftSide"
					model="[activ:[Certificates:'start active open',studycertificate:'active']]"></g:render>
				<!-- END SIDEBAR MENU -->
				<!-- END SIDEBAR MENU -->
			</div>
			<!-- END SIDEBAR -->
						...
						<div class="row">
							<div class="col-md-12">
									...
									<div class="portlet light bordered">
										...
										<div class="portlet-body form">
											...
											<div id="Reg" style="display: none">
												<g:formRemote name="ssss" url="[action:'aaaa']"
								...
								<div class="col-md-12" id="Changedisplay">
									<g:render template="/studycertificate/studyDisplay"></g:render>
								</div>
							</div>
						</div>
					</div>
