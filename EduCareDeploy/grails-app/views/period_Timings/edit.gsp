			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<g:link class="list" action="index">Period Lists</g:link></li>
						<li><i class="fa fa-circle"></i>
						<g:link class="create" action="create">Create Periods</g:link></li>
					</ul>
				</div>
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<div id="edit-period_Timings" class="content scaffold-edit"
									role="main">
									...
									<g:hasErrors bean="${period_TimingsInstance}">
										<ul class="errors" role="alert">
											<g:eachError bean="${period_TimingsInstance}" var="error">
												<li
									...
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption font-blue">
												<i class="fa fa-bell font-blue"></i> <span
													class="caption-subject bold uppercase"> Edit Period</span>
											</div>

										</div>
										<div class="portlet-body form">
											<g:form
												url="[resource:period_TimingsInstance, action:'update']"
												method="PUT">
												<g:hiddenField name="version"
													value="${period_TimingsInstance?.version}" />
												<fieldset class="form">
