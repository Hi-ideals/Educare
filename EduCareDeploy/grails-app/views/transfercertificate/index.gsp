		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<g:render template="/header/leftSide"
					model="[activ:[Certificates:'start active open',transfercertificate:'active']]"></g:render>
				<!-- END SIDEBAR MENU -->
				<!-- END SIDEBAR MENU -->
			</div>
			<!-- END SIDEBAR -->
					...
					<div class="portlet light bordered">
						...
						<div class="portlet-body form">
							...
							<button class="btn green" id="regclick">
								<i class="icon-magnifier font-white"></i> By Registration Number
								and Name
							</button>
						<div class="margin-bottom-10"></div>
							<div id="Reg" style="display: none">
								<br>
								<g:formRemote name="sss" url="[action:'tcdoc']"
									...
									<div class="row">
										<div class="col-md-4">
											...
											<div id="BregistrationNo" style="display: none; color: red;">Provide
										...
										<div class="col-md-4">
											...
											<g:submitButton name="Search" class="btn green" id="bonafied"
						...
						<br>
						<div class="table-responsive" id="Changedisplay">
							<g:render template="/transfercertificate/tcstudentdisplay"></g:render>
						</div>
					</div>
				</div>
			</div>
