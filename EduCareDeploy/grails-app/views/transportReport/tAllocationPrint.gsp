...
<body
	...
	<div class="page-container">
								...
								<div class="crtfcte">
									...
									<div class="row">
										...
										<div class="certificate">
											...
											<div class="col-md-12">
												<h4><b>Transport Report : </b></h4>
												<div class="portlet-body">
						<div class="portlet-body">
							<div class="table-scrollable">
		<g:if test="${params.type == "all" && params.routeNo == "all"}">
		...
		<g:elseif test="${(params.type == "Students" && params.routeNo == "all")
		...
		<g:elseif test="${(params.type == "Staff" && params.routeNo == "all")
