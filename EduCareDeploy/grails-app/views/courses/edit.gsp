	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			...
			<div class="page-content">
				...
				<!-- END PAGE BAR -->
				<!-- BEGIN PAGE TITLE-->
				<h3 class="page-title">Edit Course Details</h3>
				<!-- END PAGE TITLE-->
				<!-- END PAGE HEADER-->
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div id="edit-courses" class="content scaffold-edit" role="main">
							<h1>
								...
								<div class="portlet-title">
									<div class="caption font-green">
										<i class="icon-pin font-green"></i> <span
											class="caption-subject bold uppercase"> Edit Course</span>
									</div>

								</div>
								<div class="portlet-body form">
									<g:form url="[resource:coursesInstance, action:'update']"
										method="PUT">
										<g:hiddenField name="version"
											value="${coursesInstance?.version}" />
										<fieldset class="form">
