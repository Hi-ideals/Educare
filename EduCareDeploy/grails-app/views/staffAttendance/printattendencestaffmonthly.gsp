								...
								<div class="crtfcte">
									...
									<div class="row">
										...
										<div class="certificate">
											...
											<div class="col-md-12">
												<h4>
													<b>Staff attendance date : ${params?.fromDate} - ${params?.toDate}</b>
												</h4>
														...
														<g:if test="${staffList}">
															<table class="table table-bordered" id="my_table">
																...
																<tbody>
																	...
																	<g:each in="${staffattendence?.keySet()}" var="st1"
																		status="k">
																		<tr>
																			...
																			<g:each in="${staffattendence.get(st1).keySet()}"
																				var="dates" status="n">
																				<td><g:if
																						test="${staffattendence.get(st1).get(dates)=='P'}">
																						<strong style="color: green"> ${staffattendence.get(st1).get(dates)}
																						</strong>
																						<input type="hidden" value="${total++}" />
																						<input type="hidden" value="${present++}" />
																					</g:if> <g:elseif
																						test="${staffattendence.get(st1).get(dates)=='A'}">
