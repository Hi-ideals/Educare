				...
				<div class="box box-info">
					<div class="portlet light bordered">
						<div class="portlet-title">
							<div class="caption font-blue">
								<i class="icon-user font-blue"></i> <span
									class="caption-subject bold uppercase"> Staff Attendance</span>
							</div>
						</div>
						<div id="create-studentAttendance" class="content scaffold-create"
							...
							<g:hasErrors bean="${staffAttendanceInstance}">
								<ul class="errors" role="alert">
									<g:eachError bean="${staffAttendanceInstance}" var="error">
										<li
							...
							<g:formRemote name="form"
								url="[resource:staffAttendanceInstance, action:'getStaffAttendanceDetails']"
								update="getstaffdetails">
								<g:hiddenField name="instituteID" value="${institute?.id}" />
								<fieldset class="form">
									<div id="updateAttendanceDetails">
										<g:render template="attendaceDetails" />
									</div>
								</fieldset>
							</g:formRemote>
							<div id="getstafftdetails">
								<g:render template="staffAttendanceDetails"></g:render>
							</div>
							<div id="getstaffdetails">
								<g:render template="monthlySheet"></g:render>
							</div>
						</div>
					</div>
				</div>
