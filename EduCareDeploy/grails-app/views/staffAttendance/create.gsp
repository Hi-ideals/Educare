				...
				<div class="box box-info">
					<div class="portlet light bordered">
						<div class="portlet-title">
							<div class="caption font-blue">
								<i class="icon-user font-blue"></i> <span
									class="caption-subject bold uppercase"> Create New Staff
									Attendance</span>
							</div>
						</div>
						<div id="create-studentAttendance" class="content scaffold-create"
							...
							<g:form
								url="[resource:staffAttendanceInstance, action:'getStaffAttendanceSheet']">
								<fieldset class="form">
									<g:render template="form" />
								</fieldset>
								<br>
								<fieldset class="buttons">
									<g:submitButton name="create" class="btn btn-success btn blue"
