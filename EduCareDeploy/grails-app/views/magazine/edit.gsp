	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			...
			<div class="page-content">
				...
				<div id="edit-magazine" class="box box-info" role="main">
						...
						<div class="portlet-title">
							<div class="caption font-blue">
								<i class="fa fa-book font-blue"></i> <span
									class="caption-subject bold uppercase"> Edit Magazine</span>
							</div>

						</div>
						<div class="portlet-body form">
							<g:form url="[resource:magazineInstance, action:'update']"
								method="PUT">
								<g:hiddenField name="version"
									value="${magazineInstance?.version}" />
								<fieldset class="form">
									<g:render template="form" />
								</fieldset>
								<fieldset class="buttons">
									<g:actionSubmit class="btn blue" action="update" id="magazine"
										id="Createmagazine"
