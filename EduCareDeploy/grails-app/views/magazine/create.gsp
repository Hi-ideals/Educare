			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<g:link class="list" action="index">View list</g:link></li>
					</ul>
				</div>
				<div id="create-magazine" class="content scaffold-create"
					role="main">
							...
							<div class="portlet-title">
								<div class="caption font-blue">
									<i class="fa fa-book font-blue"></i> <span
										class="caption-subject bold uppercase"> Create Magazine</span>
								</div>
							...
							<div class="portlet-body form">
								<g:form url="[resource:magazineInstance, action:'save']">
									...
									<fieldset class="buttons">
										<g:submitButton name="create" class="btn blue" id="magazine"
