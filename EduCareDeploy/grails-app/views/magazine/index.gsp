				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><i class="fa fa-circle"></i> <g:link class="create"
								action="create">Create New Magazine</g:link></li>
					</ul>
				</div>
				<div class="panel">
				...
				<div id="list-magazine" class="content scaffold-list" role="main">
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-book"></i>List of Magazines
							</div>
						</div>
						<div class="portlet-body">
							<div class="table-scrollable">
								<table class="table  table-hover">
									...
									<tbody>
										<g:each in="${magazineInstanceList}" status="i"
											var="magazineInstance">
											<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">

												<td>
														${fieldValue(bean: magazineInstance, field: "magazineName")}
													</td>

												<td>
													${fieldValue(bean: magazineInstance, field: "catagory")}
												</td>

												<td>
													${fieldValue(bean: magazineInstance, field: "volume")}
												</td>
												...
												<li><g:link action="show"
														id="${LookUpED.encod(magazineInstance.id)}"> <i class="fa fa-eye"></i> View </g:link></li>
														<li>
												<g:form
					...
					<div class="col-md-12 text-center">
						<g:link class="btn blue" controller="magazine"
							action="printMagazineList" target='_blank'>Get List Of Magazines</g:link>
					</div>
