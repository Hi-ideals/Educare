								...
								<div class="crtfcte">
									...
									<div class="row">
										...
										<div class="certificate">
											...
											<div class="col-md-12">
												<h4>
													<b>List Of IssueDetails - <g:if test="${params.books}">
													BOOKS
													</g:if> <g:elseif test="${params.newspaper}">
													NEWS PAPERS
													</g:elseif> <g:elseif test="${params.magazin}">
													MAGAZINES
													</g:elseif> <g:else>
														</g:else>
													</b>
													...
													<div class="table-scrollable">
														<div class="table-scrollable">
															<g:if test="${!params.staff }">
																	...
																	<table class="table  table-hover">
																		<thead>
																			<tr style="color: #337ab7;">
																				...
																				<th><g:message
																						code="issueDetails.issuedate.label"
																		...
																		<tbody>
																			<g:each in="${issueDetailsInstanceList}" status="i"
																				...
																				<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
																					...
																					<td><g:formatDate
																							date="${issueDetailsInstance.issuedate}"
																...
																<g:elseif test="${params.newspaper}">
																	<table class="table  table-hover">
																		<thead>
																			<tr style="color: #337ab7;">
																		...
																		<tbody>
																			<g:each in="${issueDetailsInstanceList}" status="i"
																				...
																				<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
																					...
																					<td>
																						${issueDetailsInstance?.newspaper?.name.toString().replace('[', '').replace(']', '')}
																					</td>
																					<td>
																						${issueDetailsInstance?.fineAmount}
																					</td>
																		...
																		<tbody>
																			<g:each in="${issueDetailsInstanceList}" status="i"
																				...
																				<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
																					...
																					<td>
																						${issueDetailsInstance?.magazineId?.magazineName.toString().replace('[', '').replace(']', '')}
																					</td>
																					<td>
																						${issueDetailsInstance?.fineAmount}
																					</td>
																	...
																	<table class="table  table-hover">
																		<thead>
																			<tr style="color: #337ab7;">
																				...
																				<th><g:message
																						code="issueDetails.staffId.label"
