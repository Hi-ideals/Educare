			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><i class="fa fa-circle"></i> <g:link class="issueToStaff"
								action="issueToStaff">Issue to Staff</g:link></li>
					</ul>
				</div>
				<div class="panel">
								...
								<div id="list-issueDetails" class="content scaffold-list"
									...
									<div class="portlet box grey">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-user"></i>List of Issued Details
											</div>
										</div>
											...
											<div class="tab-content">
												<div class="tab-pane fade ${activeMap?.getAt('books') } in"
													...
													<div class="col-md-12 text-center">
														<g:link class="btn blue" controller="issueDetails"
															...
															params="[staff:params.staff,books:true]">Get List of Issue Details</g:link>
													</div>
												...
												<div
													...
													<div class="col-md-12 text-center">
														<g:link class="btn blue" controller="issueDetails"
															action="printissueDetailsList" target='_blank'
															params="[staff:params.staff,newspaper:true]">Get List of Issue Details</g:link>
													</div>
												</div>
												<div
													...
													<div style="text-align: center;">
														...
														<div class="col-md-12 text-center">
															<g:link class="btn blue" controller="issueDetails"
																action="printissueDetailsList" target='_blank'
																params="[staff:params.staff,magazin:true]">Get List of Issue Details</g:link>
														</div>
													</div>
