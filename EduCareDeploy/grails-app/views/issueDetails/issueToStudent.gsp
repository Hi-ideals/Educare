...
<body
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><i class="fa fa-circle"></i> <g:link class="list"
								action="studentDetails">Issued to Student</g:link></li>
					</ul>
				</div>
				<div class="panel">
														...
														<div class="row">
															...
															<div class="col-md-3" style="display: none;">
																<div
																	...
																	<select class="form-control" name="student"
																		...
																		<option value="issueDetailsStudent"
																			selected="selected">Issue to Student</option>
															...
															<div id="Returntype">
																<div class="col-md-3">
																	...
																	<div id="Sstudentname"
																		style="display: none; color: red">select student
																		name</div>
																</div>
															</div>
	...
	<g:select name="booksId" from="${com.hiideals.institute.library.Books.list()}" multiple="multiple" optionKey="id" size="5" value="${issueDetailsInstance?.booksId*.id}" class="many-to-many"/>--%>
																		...
																		<select name="books" multiple="multiple"
																			class="form-control" class="many-to-many"
																			optionKey="id" size="5">
																			<g:each
														...
														<div class="row">
															...
															<div class="col-md-3">
																<div
																	...
																	<g:field name="numberOfDays" class="form-control"
																		...
																		value="${issueDetailsInstance?.numberOfDays}"
																		required="" />

																</div>
																<div id="SNumberOfDays"
															...
															<div class="col-md-3" style="display: none;">
																<label for="accessionNumber"> <g:message
																		code="issueDetails.instituite.label"
																		default="Instituite" /> <span
																	class="required-indicator">*</span>
																</label>
																<div
