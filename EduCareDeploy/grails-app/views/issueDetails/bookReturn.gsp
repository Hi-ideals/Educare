		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<g:render template="/header/leftSide"
					model="[activ:[LibraryManagement:'start active open',Bookretuen:'active']]"></g:render>
				<!-- END SIDEBAR MENU -->
				<!-- END SIDEBAR MENU -->
			</div>
			<!-- END SIDEBAR -->
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><i class="fa fa-circle"></i> <g:link class="list"
								action="index">Issued Student Details</g:link></li>
					</ul>
				</div>
				<div class="panel">
										...
										<div class="box box-info">
											<div class="portlet light bordered">
												...
												<div
													...
													<select id="staffId" class="form-control" name="staffId.id">
														<option value="${null }">select</option>
														<g:each in="${com.hiideals.institute.staff.Staff.findAllByInstitute(institute)}">
															<option value="${it.id}">
																${it.staffName}
															</option>
											...
											--%>
															...
															<div id="category1" hidden="true">
																<div class="col-md-3">
																	...
																	<div
																		class="magazineContains ${hasErrors(bean: issueDetailsInstance, field: 'magazineId', 'error')} ">
														...
														<div class="row">
															<div id="category3" hidden="true">
																<div class="col-md-3">
																	...
																	<div
																		class="bookscontains ${hasErrors(bean: issueDetailsInstance, field: 'booksId', 'error')} ">
...
<![endif]-->
	...
	$('#categorys').on('change', function() {
		var conceptName = $('#studentId').find(":selected").val();
		var cat=$('#categorys').find(":selected").val();
		alert(conceptName)
		var jqxhr = $.post( "/vidya/issueDetails/getDetails",{studentId:conceptName,categorys:cat});

		jqxhr.done(function(data) {
			$(".bookscontains").html(data);
