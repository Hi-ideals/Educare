			...
			<div class="page-content">
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><i class="fa fa-circle"></i> <g:link class="create"
								action="create">Create New Transport</g:link></li>
					</ul>
				</div>
				...
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<div id="list-transport" class="content scaffold-list"
									role="main">
									...
									<div class="portlet box grey">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-bus"></i>Lists of Transport
											</div>
										</div>
									...
									<div style="text-align: center;">
										<ul class="pagination">
											<li><g:paginate total="${transportInstanceCount ?: 0}" /></li>
										</ul>
									</div>
								</div>
							</div>
