		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<g:render template="/header/leftSide"
					model="[activ:[tt:'start active open',ttcreate:'active']]"></g:render>
			</div>
		</div>
			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><i class="fa fa-circle"></i> <a class="home"
							href="${createLink(uri: '/SelectTimeTableDate')}"> TimeTable
								List </a></li>
					</ul>
				</div>
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<div id="create-timeTable" class="content scaffold-create"
									role="main">
									...
									<div class="box box-info">
										<div class="portlet light bordered">
											...
											<div class="portlet-body form">
												<g:form url="[resource:timeTableInstance, action:'save']">
													<fieldset class="form">
													...
													<fieldset class="buttons">
														<g:submitButton name="create" class="save btn blue"
															value="${message(code: 'default.button.create.label', default: 'Create11')}" />
														<a href="#" onclick="changeForm()" style="display: none;"
															id="resetTime" class="save btn blue"><b>Reset
																Table</b></a>
													</fieldset>
												</g:form>
											</div>
