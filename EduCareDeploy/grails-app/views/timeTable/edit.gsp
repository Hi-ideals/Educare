			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<g:link class="list" action="index">TimeTable List</g:link></li>
						<li><i class="fa fa-circle"></i>
						<g:link class="create" action="create">Create imetable</g:link></li>
					</ul>
				</div>
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<div id="edit-timeTable" class="content scaffold-edit"
									role="main">
										...
										<div class="portlet light bordered">
											<div class="portlet-title">
												<div class="caption font-green">
													<i class="fa fa-bars font-green"></i> <span
											...
											<div class="portlet-body form">
												<g:form url="[resource:timeTableInstance, action:'update']"
													method="PUT">
													<g:hiddenField name="version"
														value="${timeTableInstance?.version}" />
													<fieldset class="form">
