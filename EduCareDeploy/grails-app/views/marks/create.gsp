			...
			<div class="page-content">
				...
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<div id="create-marks" class="content scaffold-create"
									role="main">
										...
										<div class="portlet light bordered">
											<div class="portlet-title">
												<div class="caption font-blue">
													<i class="fa fa-bookaAAAAAAAAAAAAAAAAAAAAAA font-blue"></i>
													<span class="caption-subject bold uppercase"> Create
														Marks</span>
												</div>

											</div>
											<div class="portlet-body form">
												<g:form url="[resource:marksInstance, action:'save']">
													<fieldset class="form">
