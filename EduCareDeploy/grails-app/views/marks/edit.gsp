				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><i class="fa fa-circle"></i> <g:link class="list"
								action="index">Marks List</g:link></li>
						<li><i class="fa fa-circle"></i> <g:link class="create"
								action="create">Create New Mark</g:link></li>
					</ul>
				</div>
				<div class="panel">
					<div class="panel-body">
						<div id="edit-marks" class="content scaffold-edit" role="main">
							...
							<br>
							<g:hasErrors bean="${marksInstance}">
								<ul class="errors" role="alert">
									<g:eachError bean="${marksInstance}" var="error">
										<li
									...
									<div class="portlet-title">
										<div class="caption font-blue">
											<i class="fa fa-book font-blue"></i> <span
												class="caption-subject bold uppercase">Edit Marks</span>
										</div>

									</div>
									<div class="portlet-body form">
										<g:form url="[resource:marksInstance, action:'update']"
											method="PUT">
											<g:hiddenField name="version"
												value="${marksInstance?.version}" />
											<fieldset class="form">
