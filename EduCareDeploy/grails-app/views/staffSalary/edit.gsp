		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<g:render template="/header/leftSide"
					model="[activ:[payroll:'start active open',staffcreate:'active']]"></g:render>
				<!-- END SIDEBAR MENU -->
				<!-- END SIDEBAR MENU -->
			</div>
			<!-- END SIDEBAR -->
			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><g:link action="index">List of Staff Salary</g:link></li>
									...
									<div class="box box-info">
										<div class="portlet light bordered">
											<div class="portlet-title">
												<div class="caption font-blue">
													<i class="fa fa-rupee font-blue"></i> <span
														class="caption-subject bold uppercase"> Edit Staff
														Salary</span>
												</div>
											...
											<div class="portlet-body form">
												<g:form
													url="[resource:staffSalaryInstance, action:'update']"
													method="PUT">
													<g:hiddenField name="version"
														value="${staffSalaryInstance?.version}" />
													<fieldset class="form">
