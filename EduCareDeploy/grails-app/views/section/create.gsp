		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<g:render template="/header/leftSide"
					model="[activ:[Settings:'start active open',section:'active']]"></g:render>
				<!-- END SIDEBAR MENU -->
				<!-- END SIDEBAR MENU -->
			</div>
			<!-- END SIDEBAR -->
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								...
								<div id="create-section" class="content scaffold-create"
									role="main">
												...
												<g:form url="[resource:sectionInstance, action:'save']">
													...
													<fieldset class="buttons">
														<g:if test="${instituite == null }">
															<div style="color: red">
																<sec:username />
																Cannot add a section Fees without an Instituite.
															</div>
