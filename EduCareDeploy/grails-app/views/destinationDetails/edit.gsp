	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			...
			<div class="page-content">
				...
				<div id="edit-destinationDetails" class="content scaffold-edit"
					role="main">
					...
					<g:hasErrors bean="${destinationDetailsInstance}">
						<ul class="errors" role="alert">
							<g:eachError bean="${destinationDetailsInstance}" var="error">
								<li
						...
						<div class="portlet light bordered">
							<div class="portlet-title">
								<div class="caption font-blue">
									<i class="fa fa-road font-blue"></i> <span
										class="caption-subject bold uppercase"> Edit Details</span>
								</div>

							</div>
							<div class="portlet-body form">
								<g:form
									url="[resource:destinationDetailsInstance, action:'update']"
									method="PUT">
									<g:hiddenField name="version"
										value="${destinationDetailsInstance?.version}" />
									<fieldset class="form">
										<g:render template="form" />
									</fieldset>
									<br>
									<fieldset class="buttons">
										<g:actionSubmit class="save btn blue" action="update" id="destinationDetails"
