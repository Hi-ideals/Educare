				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><i class="fa fa-circle"></i> <g:link class="create"
								action="create">Create</g:link></li>
					</ul>
				</div>
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<div id="list-destinationDetails" class="content scaffold-list"
									role="main">
									...
									<div class="portlet box grey">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-road"></i>Lists of Destination Details
											</div>
										</div>
										<div class="portlet-body">
											<div class="table-scrollable">
												<table class="table table-bordered table-hover">
													...
													<tbody>
														<g:each in="${destinationDetailsInstanceList}" status="i"
															var="destinationDetailsInstance">
															<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">



																<td>
																	${fieldValue(bean: destinationDetailsInstance, field: "route.routeCode")}
																</td>

																<td>
																	${fieldValue(bean: destinationDetailsInstance, field: "fromPlace")}
																</td>

																<td>
																	${fieldValue(bean: destinationDetailsInstance, field: "toPlace")}
																</td>



																<td>
																	${fieldValue(bean: destinationDetailsInstance, field: "amount")}
																</td>
																<td>
									...
									<div style="text-align: center;">
										<ul class="pagination">
											<li><g:paginate
													total="${destinationDetailsInstanceCount ?: 0}" /></li>
										</ul>
									</div>
								</div>
							</div>
