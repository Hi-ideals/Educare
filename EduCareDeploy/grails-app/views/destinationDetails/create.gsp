				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><i class="fa fa-circle"></i> <g:link class="list"
								action="index">Destination List</g:link></li>
					</ul>
				</div>
				<div id="create-destinationDetails" class="content scaffold-create"
					role="main">
					...
					<div class="box box-info">
						<div class="portlet light bordered">
							...
							<div class="portlet-body form">
								<g:form
									url="[resource:destinationDetailsInstance, action:'save']">
									<fieldset class="form">
