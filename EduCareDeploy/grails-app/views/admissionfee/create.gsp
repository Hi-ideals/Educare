		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<g:render template="/header/leftSide"
					model="[activ:[feeStructure:'start active open',admissionfeecreate:'active']]"></g:render>
			</div>
		</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div id="create-instituite" class="content scaffold-create"
									...
									<g:hasErrors bean="${admissionfeeInstance}">
										<ul class="errors" role="alert">
											<g:eachError bean="${admissionfeeInstance}" var="error">
												<li
											...
											<div class="portlet-title">
												<div class="caption font-blue">
													<i class="fa fa-rupee font-blue"></i> <span
														...
														Admission Fee Details</span>
												</div>

											</div>
											<div class="portlet-body form">
												<g:form url="[resource:admissionfeeInstance, action:'save']"
