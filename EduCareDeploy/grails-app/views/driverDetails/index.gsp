				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><i class="fa fa-circle"></i> <g:link class="create"
								action="create">Create Driver</g:link></li>
					</ul>
				</div>
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<div id="list-driverDetails" class="content scaffold-list"
									role="main">
									...
									<div class="portlet box grey">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-user"></i>Lists of Driver's
											</div>
										</div>
													...
													<tbody>
														<g:each in="${driverDetailsInstanceList}" status="i"
															...
															<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
																...
																<li>
																<g:link action="show"
																		id="${LookUpED.encod(driverDetailsInstance.id)}"><i class="fa fa-eye"></i> View</g:link>
																</li>
																<li>
																<g:form
									...
									<div style="text-align: center;">
										<ul class="pagination">
											<li><g:paginate
													total="${driverDetailsInstanceCount ?: 0}" /></li>
										</ul>
									</div>
								</div>
							</div>
