			...
			<div class="page-content">
				...
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<div id="create-driverDetails" class="content scaffold-create"
									role="main">
									...
									<g:hasErrors bean="${driverDetailsInstance}">
										<ul class="errors" role="alert">
											<g:eachError bean="${driverDetailsInstance}" var="error">
												<li
											...
											<div class="portlet-title">
												<div class="caption font-blue">
													<i class="fa fa-user font-blue"></i> <span
														class="caption-subject bold uppercase"> Add Driver</span>
												</div>

											</div>
											<div class="portlet-body form">
												<g:form
													url="[resource:driverDetailsInstance, action:'save']">
													<fieldset class="form">
