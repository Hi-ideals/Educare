				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><i class="fa fa-circle"></i> <g:link class="list"
								action="index">PayHead Lists</g:link></li>
						<li><i class="fa fa-circle"></i> <g:link class="create"
								action="create">Create New PayHead</g:link></li>
					</ul>
				</div>
				<div class="panel">
								...
								<div id="show-magazine" class="content scaffold-show"
									...
									<div class="portlet box black">
										<table class="table table-bordered table-hover">
											...
											<g:if test="${payHeadInstance?.description}">
												<tr>
													<td width="25%"><span id="description-label"
														class="property-label"><g:message
																code="payHead.description.label" default="Description" /></span>
													</td>
													<td><span
														class="property-value caption-subject bold uppercase"
														aria-labelledby="description-label"><g:fieldValue
																bean="${payHeadInstance}" field="description" /></span></td>
												</tr>
											</g:if>

											<g:if test="${payHeadInstance?.payHeadType}">
												<tr>
													<td><span id="payHeadType-label"
														class="property-label"><g:message
																code="payHead.payHeadType.label" default="Pay Head Type" /></span>
													</td>
													<td><span
														class="property-value caption-subject bold uppercase"
														aria-labelledby="payHeadType-label"><g:fieldValue
																bean="${payHeadInstance}" field="payHeadType" /></span>
													</li></td>
												</tr>
											</g:if>

											<g:if test="${payHeadInstance?.payHeadName}">
												<tr>
													<td><span id="payHeadName-label"
														class="property-label"><g:message
																code="payHead.payHeadName.label" default="Pay Head Name" /></span>
													</td>
													<td><span
														class="property-value caption-subject bold uppercase"
														aria-labelledby="payHeadName-label"><g:fieldValue
																bean="${payHeadInstance}" field="payHeadName" /></span>
													</li></td>
												</tr>
											</g:if>
											<tr>
												<td>Actions</td>
												<td><g:form
														url="[resource:payHeadInstance, action:'delete']"
														method="DELETE">
														<fieldset class="buttons">

															<g:link class="btn yellow" action="edit"
																id="${LookUpED.encod(payHeadInstance.id)}">
