		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<g:render template="/header/leftSide"
					model="[activ:[payroll:'start active open',payheadcreate:'active']]"></g:render>
				<!-- END SIDEBAR MENU -->
				<!-- END SIDEBAR MENU -->
			</div>
			<!-- END SIDEBAR -->
			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><g:link action="index">Payhead Lists</g:link></li>
									...
									<div class="portlet-title">
										<div class="caption font-blue">
											<i class="icon-user font-blue"></i> <span
												class="caption-subject bold uppercase"> Edit Payhead</span>
										</div>

									</div>
									<div class="portlet-body form">
										<g:form url="[resource:payHeadInstance, action:'update']"
											method="PUT">
											<g:hiddenField name="version"
												value="${payHeadInstance?.version}" />
											<fieldset class="form">
												<g:render template="form" />
											</fieldset><br>
											<fieldset class="buttons">
												<g:actionSubmit class="save btn blue" action="update" id="payHead"
