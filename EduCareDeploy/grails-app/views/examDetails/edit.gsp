				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><i class="fa fa-circle"></i> <g:link class="list"
								action="index">ExamDetails List</g:link></li>
						<li><i class="fa fa-circle"></i> <g:link class="create"
								action="create">Create New ExamDeatils</g:link></li>
					</ul>
				</div>
				<div class="panel">
					<div class="panel-body">

						<div id="edit-examDetails" class="content scaffold-edit"
							role="main">
							...
							<div class="box box-info">
								<div class="portlet light bordered">
									...
									<div class="portlet-body form">
										<g:form url="[resource:examDetailsInstance, action:'update']"
											method="PUT">
											<g:hiddenField name="version"
												value="${examDetailsInstance?.version}" />
											<fieldset class="form">
