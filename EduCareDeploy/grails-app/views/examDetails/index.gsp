				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><i class="fa fa-circle"></i> <g:link class="create"
								action="create">Add Exam Details</g:link></li>
					</ul>
				</div>
				<div class="panel">
					<div class="panel-body">
						<div id="list-examDetails" class="content scaffold-list"
							role="main">
							...
							<div class="portlet box grey">
								<div class="portlet-title">
									<div class="caption">
										<i class="fa fa-book"></i>Lists of Exams
									</div>
								</div>
								<div class="portlet-body">
									<div class="table-scrollable">
										<table class="table table-bordered table-hover">
											...
											<tbody>
												<g:each in="${examDetailsInstanceList}" status="i"
													var="examDetailsInstance">
													<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">

														<td>
																<g:formatDate date="${examDetailsInstance?.examDate}"
														...
														<td><g:link action="show"
																id="${LookUpED.encod(examDetailsInstance.id)}">View</g:link></td>
													</tr>
												</g:each>
											</tbody>
										</table>
									...
									<div style="text-align: center;">
										<ul class="pagination">
											<li><g:paginate total="${examDetailsInstanceCount ?: 0}" /></li>
										</ul>
									</div>
								</div>
							</div>
