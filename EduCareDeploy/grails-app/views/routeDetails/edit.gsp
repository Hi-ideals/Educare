			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<g:link class="list" action="index">Route's List</g:link></li>
						<li><i class="fa fa-circle"></i>
						<g:link class="create" action="create">Create New Route</g:link></li>
					</ul>
				</div>
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<div id="edit-routeDetails" class="content scaffold-edit"
									role="main">
									...
									<g:hasErrors bean="${routeDetailsInstance}">
										<ul class="errors" role="alert">
											<g:eachError bean="${routeDetailsInstance}" var="error">
												<li
									...
									<div class="box box-info">
										...
										<div class="portlet-body form">
											<g:form
												url="[resource:routeDetailsInstance, action:'update']"
												method="PUT">
												<g:hiddenField name="version"
													value="${routeDetailsInstance?.version}" />
												<fieldset class="form">
													<g:render template="form" />
												</fieldset>
												<br>
												<fieldset class="buttons">
													<g:actionSubmit class="save  btn blue" id="routeDetails"
														action="update"
