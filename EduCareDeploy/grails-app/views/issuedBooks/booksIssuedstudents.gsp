								...
								<div class="crtfcte">
									...
									<div class="row">
										...
										<div class="certificate">
											...
											<div class="col-md-12">
												<h4>
													<b>List Of Books Issued To Students .</b>
												</h4>
														...
														<table class="table  table-hover">
															...
															<g:each in="${issuedToStudents}">
																...
																<tr>
																	...
																	<td>
																		${it.studentId.presentclass }
																	</td>
																	<td>
																		${it.studentId.studentName }
																	</td>
																	<td>
																	...
																	<td><g:formatDate format="dd-MMM-yyyy"
																			date="${it.dateOfIssue}" /></td>
																	<td><g:formatDate format="dd-MMM-yyyy"
																			date="${it.dateOfReturn}" /></td>
