			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><g:link action="create">Create New User</g:link></li>
					</ul>
										...
										<div class="portlet-body">
											<div class="table-responsive">
												<table class="table table-bordered table-hover">
													...
													<tbody>
														<g:each in="${userListInstanceList}" status="i"
															var="userListInstance">
															<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">

																<td>
																	${fieldValue(bean: userListInstance, field: "userName")}
																</td>
																<td><g:formatDate
																		date="${userListInstance.dateCreated}"
																		format="dd-MMM-yyyy" /></td>
																<td><g:link action="show"
																		id="${LookUpED.encod(userListInstance.id)}">View Details</g:link></td>
															</tr>
														</g:each>
													</tbody>
												</table>
												<div class="pagination">
													<g:paginate total="${userListInstanceCount ?: 0}" />
												</div>
											</div>
										</div>
									</div>
