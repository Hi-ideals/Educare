			...
			<div class="page-content">
				...
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<div id="create-userList" class="content scaffold-create"
									role="main">
									<h3>Create User</h3>
									...
									<g:hasErrors bean="${userListInstance}">
										<ul class="errors" role="alert">
											<g:eachError bean="${userListInstance}" var="error">
												<li
									...
									<g:form url="[resource:userListInstance, action:'save']">
										<fieldset class="form">
										...
										<fieldset class="buttons">
											<g:submitButton name="create" class="btn btn-primary"
												id="CreateUserList" disabled="disabled"
