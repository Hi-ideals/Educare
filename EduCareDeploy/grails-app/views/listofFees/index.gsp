					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12" id="hi">
								...
								<button class="btn green" id="regclick">
									<i class="icon-magnifier font-white"></i> By Date Fee Collection Amount
								</button>
								<button class="btn green" id="yearclick">
											...
											<button class="btn blue" id="classclick">
												<i class="icon-magnifier font-white"></i> By Amount
											</button>
											<button class="btn yellow" id="dateclick">
												<i class="icon-magnifier font-white"></i> By Date Total Fees Paid 
											</button>
											<%--
								<g:link controller="listofStudents" action="getstudentlist" target='_blank'>Get all student list</g:link>
								 --%>
											...
											<div id="datee" style="display: none">

												<g:form action="individualstudentFees" target='_blank'>
													
													<div class="row">

														<div class="col-md-4">
															<label>From</label> <input type="text" name="from"
																id="datepickerr" class="form-control date-picker">
														</div>
														<div class="col-md-4">
															<label>To</label> <input type="text" name="to"
																id="datepickerr1" class="form-control date-picker"
																value="${params.to }">
														</div>
									...
									<div class="col-md-2">
											<div
												...
												<select name="iclass" class="form-control">
													<option value="all">All</option>
						...
						--%>
									<div class="portlet box grey">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-rupee"></i> List of Fees with student Name
											</div>
										</div>
														...
														<g:each in="${feeInstanceList}" status="i"
															...
															<g:if test="${feeInstance !=null }">
																<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                                                    ...
                                                                    <td>
																		${fieldValue(bean: feeInstance?.studentId?.fatherDetails, field: "parentName")}
																	</td>
																	...
																	<td>
							<g:formatDate format="dd-MMM-yyyy" date="${feeInstance.dateCreated}"/>
							</td>
							<td>
							<g:formatDate format="dd-MMM-yyyy" date="${feeInstance.lastUpdated}"/>
							</td>
								...
								<div class="text-center">
									<g:form controller="listofFees" action="getfeelist"
										target='_blank'>
