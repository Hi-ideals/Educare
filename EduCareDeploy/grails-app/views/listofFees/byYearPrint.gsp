										...
										<div class="">
											<ul class="list-unstyled">
												...
												<li>
													...
													<small>
														${instituite?.hsno} ${instituite?.street} ${instituite?.city}-${instituite?.pinCode}
...
<td>
																			${fieldValue(bean: studentInstance?.studentId?.academicyear?.presentclass, field: "classname").toString().replace('[', '').replace(']', '')}
																		</td>
																		...
																		<%--<td>
																			${fieldValue(bean: studentInstance, field: "discount")}
																		</td>
...
<td>
																			${fieldValue(bean: studentInstance, field: "due")}
																		</td>
                                                                        <td><g:formatDate format="dd-MMM-yyyy"
																				date="${studentInstance.dateCreated}" /></td>

																		<td><g:formatDate format="dd-MMM-yyyy"
																				date="${studentInstance.lastUpdated}" /></td>

																		
																		<td>
																			${fieldValue(bean: studentInstance?.studentId?.academicyear, field: "academicyear").toString().replace('[', '').replace(']', '')}
																		</td>
