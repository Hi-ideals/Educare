				...
				<div class="well" style="padding: 1px">
					<div class="text-left">
						<ul class="list-inline">
							<li><images:getImage id="${instituite?.logo?.id}" /> <br>
										...
										<div class="portlet-body">
											<div class="table-scrollable">
												<table class="table table-bordered table-hover">
													...
													<tbody>
														<g:each in="${feedueList}" status="i" var="feedue">

															<tr>

																<td>
																	${fieldValue(bean: feedue?.studentId, field: "studentName")}
																</td>


																<td>
																	${fieldValue(bean: feedue, field: "due")}
																</td>

																<td>
																	${fieldValue(bean: feedue, field: "totalFee")}
																</td>

																<td>
																	${fieldValue(bean: feedue, field: "totalPaid")}
																</td>
