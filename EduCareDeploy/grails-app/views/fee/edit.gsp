	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			...
			<div class="page-content">
				...
				<h3 class="page-title">Student Fee Collection</h3>
				<h5>
					<b>Student Name : ${feeInstance?.studentId?.studentName}</b>
				</h5>
				<h5>
					<b>Class : <g:each in="${feeInstance?.studentId?.academicyear}">
				...
				<div class="row">
					<div class="col-md-12">
						<div id="edit-fee" class="content scaffold-edit" role="main">
							...
							<g:form url="[resource:feeInstance, action:'update']"
								method="PUT">
								...
								<fieldset class="pull-right">
									<g:actionSubmit class="btn blue" id="paypal" action="update"
										value="Pay Fees" />
								</fieldset>
							</g:form>
						</div>
						...
						<script type="text/javascript">
							function doMath(vv) {
								...
								//	alert("asdfasfd"+document.getElementById('amountPaid_' + nn))
										...
										.each(
												function() {
													...
													var admissionfee = $(
															"#admissionfee")
															.val()
													var admissionfeepaid = $(
															"#paidadmissionfee")
															.val()

													if ($td.index() == 3) {
														var admissionfeepaid = parseInt($(
																'#paidadmissionfee')
																.val())
														totalPaid = colTotal
																+ admissionfeepaid;
		...
		<g:render template="/footer/footer"></g:render></div>
