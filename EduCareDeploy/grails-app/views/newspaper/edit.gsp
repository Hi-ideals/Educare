			...
			<div class="page-content">
				...
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<div id="edit-newspaper" class="content scaffold-edit"
									role="main">
									...
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption font-blue">
												<i class="fa fa-newspaper-o font-blue"></i> <span
										...
										<div class="portlet-body form">
											<g:form url="[resource:newspaperInstance, action:'update']"
												method="PUT">
												<g:hiddenField name="version"
													value="${newspaperInstance?.version}" />
												<fieldset class="form">
