				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><i class="fa fa-circle"></i> <g:link class="create"
								action="create">Create Newspaper</g:link></li>
					</ul>
				</div>
				<div class="panel">
					<div class="panel-body">
						<div id="list-newspaper" class="row">
							<div class="col-md-12">

								<g:if test="${flash.message}">
									<div class="message" role="status" style="color: green">
										${flash.message}
									</div>
								</g:if>
								<div class="portlet box grey">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-newspaper-o"></i>List of Newspapers
										</div>
									</div>
										...
										<div class="table-scrollable">
											<table class="table table-bordered table-hover">
												<thead>
													<tr>
														<th>Name</th>
														<th>Date of newspaper</th>
														<th>Cost</th>
														<th>Actions</th>
													</tr>
												</thead>
												<tbody>
													<g:each in="${newspaperInstanceList}" status="i"
														var="newspaperInstance">
														<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">

															<td>
																${fieldValue(bean: newspaperInstance, field: "name")}
															</td>

															<td><g:formatDate
																	date="${newspaperInstance.dateofnewspaper}"
																	format="dd-MMM-yyyy" style="SHORT" /></td>

															<td>
																${fieldValue(bean: newspaperInstance, field: "cost")}
															</td>
															<td>
								...
								<div class="col-md-12 text-center">
									<g:link class="btn blue" controller="newspaper"
										action="printNewspaperList" target='_blank'>Get List Of NewsPapers</g:link>
								</div>
