		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<g:render template="/header/leftSide"
					model="[activ:[payroll:'start active open',salarysettingcreate:'active']]"></g:render>
				<!-- END SIDEBAR MENU -->
				<!-- END SIDEBAR MENU -->
			</div>
			<!-- END SIDEBAR -->
			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><g:link action="index">Create Salary</g:link></li>
									...
									<div class="box box-info">
										<div class="portlet light bordered">
											...
											<div class="portlet-body form">
												<g:form
													url="[resource:salarySettingInstance, action:'update']"
													method="PUT">
													<g:hiddenField name="version"
														value="${salarySettingInstance?.version}" />
													<fieldset class="form">
