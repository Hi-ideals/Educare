...
<div id="printableArea">
					...
					<tbody>
						<g:each in="${studentInstanceList}" status="i"
							...
							--%>
                                ...
                                </g:link> || <g:link controller="student"
										action="reAdmission" id="${studentInstance.id}">ReAdmission</g:link>
										|| <g:link controller="student" action="transfer"
	...
	<g:hiddenField type="text" name="act" id="act" value="${params.action}" />
...
<script>
	$(".step").click(function(event) {
		...
		jQuery.ajax({
			...
			url : '${APPConsumer.AJAX_NAME}/studentList/'+action+'?' + ss,
