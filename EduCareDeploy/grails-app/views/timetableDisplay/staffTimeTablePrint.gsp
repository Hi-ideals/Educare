									...
									<div class="row">
										...
										<div class="certificate">
											...
											<div class="col-md-12">
												...
												<h4>
													<b>Staff Name : ${staff?.staffName}</b>
												</h4>
													...
													<div class="table-scrollable">
														<table class="table  table-hover">
															<tr>
																...
																<g:each in="${1..8}">
																	<th width="${(100/9)}%"><div align="center">
																			${it}
																		</div></th>
																</g:each>
															</tr>
															<g:each in="${weekdaysMap.keySet()}">
																<tr>
																	...
																	<g:each in="${1..8}">
																		<td width="${(100/9)}%"><g:if
																				test="${aaa.getAt(it.toString()) }">
																				<div align="center">
																					${aaa.getAt(it.toString())?.classname?.classname }
																					:
																					${aaa.getAt(it.toString())?.section?.sectionName }<br>
