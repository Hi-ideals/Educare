		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<g:render template="/header/leftSide"
					model="[activ:[Certificates:'start active open',bonafiedcertificate:'active']]"></g:render>
			</div>
		</div>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								...
								--%>
											<div id="Reg">
												<g:formRemote name="sss" url="[action:'aaa']"
									...
									<div class="col-md-12" id="Changedisplay">
										<g:render template="/bonafiedcrt/studentdisplay"></g:render>
									</div>
								</div>
							</div>
						</div>
