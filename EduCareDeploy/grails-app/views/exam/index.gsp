				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><i class="fa fa-circle"></i> <g:link class="create"
								action="create">Create New Exam</g:link></li>
					</ul>
				</div>
				<div class="panel">
								...
								<div id="list-exam" class="content scaffold-list" role="main">
									...
									<div class="portlet box grey">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-book"></i>Lists of Exam
											</div>
										</div>
										<div class="portlet-body">
											<div class="table-scrollable">
												<table class="table table-bordered table-hover">
													...
													<tbody>
														<g:each in="${examInstanceList}" status="i"
															var="examInstance">
															<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">

																<td>
																		${fieldValue(bean: examInstance, field: "examName")}
																	</td>
																	<td><g:link action="show"
																		id="${LookUpED.encod(examInstance.id)}">View </g:link></td>
											...
											<div style="text-align: center;">
												<ul class="pagination">
													<li><g:paginate total="${examInstanceCount ?: 0}" /></li>
												</ul>
											</div>
