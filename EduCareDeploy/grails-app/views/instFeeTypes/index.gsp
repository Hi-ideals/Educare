		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<g:render template="/header/leftSide"
					model="[activ:[feeStructure:'start active open',instFeeTypesList:'active']]"></g:render>
				<!-- END SIDEBAR MENU -->
				<!-- END SIDEBAR MENU -->
			</div>
			<!-- END SIDEBAR -->
		...
		<div class="page-content-wrapper">
			...
			<div class="page-content">
				...
				<div class="panel">
					...
					<button class="btn blue" id="regclick">
						<i class="icon-magnifier font-white"></i> By Class
					</button>

					<div id="Reg" style="display: none">
						<div class="margin-bottom-10"></div>
						<g:formRemote name="ss" url="[action:'index']"
							...
							<div class="row">
								<div class="col-md-4">
									...
									<select name="iclass" class="form-control">
										...
										<g:if test="${instFeeTypesInstanceList?.size()>0}">
											<g:each
												in="${IClass.findAllByInstituite(instFeeTypesInstanceList[0]?.instituite)}"
												var="cls">
												<option value="${cls.id }">
													${cls.classname }
												</option>
								...
								<div class="col-md-4">
									<g:submitButton name="Search" class="btn blue" style="margin-top:21px"/>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div id="list-instFeeTypes" class="content scaffold-list"
							role="main">
								...
								<div class="portlet-body">
									<div class="table-scrollable">
										<table class="table table-bordered table-hover">
											...
											<tbody>
												<g:each in="${instFeeTypesInstanceList}" status="i"
													var="instFeeTypesInstance">
													<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
														...
														<td><g:form
																url="[resource:instFeeTypesInstance, action:'delete']"
																method="DELETE">
												...
												<tr style="color: #337ab7">
													...
													<td><b></b></td>
													<td><b>
															<i class="fa fa-rupee"></i> ${Totalsum}
													</b></td>
													<td colspan="1"></td>
												</tr>
											</tbody>
							...
							<div style="text-align: center;">
								<ul class="pagination">
									<li><g:paginate total="${instFeeTypesInstanceCount ?: 0}"
											params="${params}" /></li>
								</ul>
							</div>
						</div>
