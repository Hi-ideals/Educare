			...
			<div class="page-content">
				...
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<div id="edit-instFeeTypes" class="content scaffold-edit"
									role="main">
									...
									<div class="box box-info">
										<div class="portlet light bordered">
											<div class="portlet-title">
												<div class="caption font-green">
													<i class="icon-pin font-green"></i> <span
														class="caption-subject bold uppercase"> Edit New
														Fees</span>
												</div>
											...
											<div class="portlet-body form">
												<g:form
													url="[resource:instFeeTypesInstance, action:'update']"
													method="PUT">
													<g:hiddenField name="version"
														value="${instFeeTypesInstance?.version}" />
													<fieldset class="form">
