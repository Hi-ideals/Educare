						...
						<div class="row">
							<div class="col-md-12">
								<div id="create-preEducation" class="content scaffold-create"
									...
									<g:hasErrors bean="${preEducationInstance}">
										<ul class="errors" role="alert">
											<g:eachError bean="${preEducationInstance}" var="error">
												<li
									...
									<div class="box box-info">
										<div class="portlet light bordered">
											...
											<div class="portlet-body form">
												<g:form url="[resource:preEducationInstance, action:'save']"
													...
													<fieldset class="buttons">
														...
														<g:link class="btn yellow" controller="fee"
															action="create"
															id="${LookUpED.encod(studentInstance.id) }">Skip</g:link>
													</fieldset>
												</g:form>
											</div>
										</div>
