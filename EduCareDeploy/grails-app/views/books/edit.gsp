			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><g:link action="index">Book Lists</g:link></li>
									...
									<div class="portlet-title">
										<div class="caption font-blue">
											<i class="icon-pin font-blue"></i> <span
												class="caption-subject bold uppercase">Edit Books</span>
										</div>

									</div>
									<div class="portlet-body form">
										<g:form url="[resource:booksInstance, action:'update']"
											method="PUT">
											<g:hiddenField name="version"
												value="${booksInstance?.version}" />
											<fieldset class="form">
												<g:render template="form" />
											</fieldset>
											<fieldset class="buttons">
												<g:actionSubmit class="save blue btn" action="update"
													id="books"
