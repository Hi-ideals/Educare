				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><i class="fa fa-circle"></i> <g:link class="create"
								action="create">Create New Books</g:link></li>
					</ul>
				</div>
				<div class="panel">
								...
								<div id="list-magazine" class="content scaffold-list"
									...
									<div class="portlet box grey">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-book"></i>List of Books
											</div>
										</div>
										<div class="portlet-body">
											<div class="table-scrollable">
												<table class="table table-bordered table-hover">
													...
													<tbody>
														<g:each in="${booksInstanceList}" status="i"
															var="booksInstance">
															<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">

																<td>
																		${fieldValue(bean: booksInstance, field: "author")}
																	</td>

																<td>
																	${fieldValue(bean: booksInstance, field: "title")}
																</td>

																<td>
																	${fieldValue(bean: booksInstance, field: "publisher")}
																</td>

																<td>
																	${fieldValue(bean: booksInstance, field: "place")}
																</td>
																...
																<g:link action="show"
																		...
																		<i class="fa fa-eye"></i> View</g:link>
									...
									<div class="col-md-12 text-center">
										<g:link class="btn blue" controller="books"
											action="printBooksList" target='_blank'>Get List Of Books</g:link>
									</div>
