...
<g:form controller="charactercertificate" action="printcharactercrt">
	<g:if test="${student?.studentName==null}">
		<p style="color: #ff4900">Please enter register number and student
			name</p>
	</g:if>
	<g:else>
		...
		<div class="portlet box grey">
			...
			<div class="portlet-body">
				...
				<g:actionSubmit class="btn blue" action="printcharactercrt"
