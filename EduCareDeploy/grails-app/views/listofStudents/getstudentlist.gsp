							...
							<div class="portlet-body form">
								...
								<th style="display:none"><g:message code="student.fatherDetails.label"
										...
										default="Registration Number"/></th>
																	...
																	<th><g:message
																			code="student.guardianDetails.label"
																			default="Student Name" /></th>
																			
																			<th>FatherName</th>

																	<th><g:message
																			code="student.guardianDetails.label" default="Class " /></th>
																	<th>Section</th>
...
<td>
							...
							<td id="printPageButton">
								<g:link controller="student" action="show" id="${LookUpED.encod(studentInstance.id)}">
