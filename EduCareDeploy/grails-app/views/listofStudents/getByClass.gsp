							...
							<div class="portlet-body form">
								...
								<th style="display:none"><g:message code="student.fatherDetails.label"
										...
										<td> ${fieldValue(bean: studentInstance, field: "registrationNo")}</td>
																		...
																		<g:set
																			value="${IClass.findById(params?.iclass).classname}"
																			var="icalssname"></g:set>
																		<g:if test="${params?.academicyear=='all' }">
																			<g:each in="${studentInstance?.academicyear}">

																				<g:if
																					test="${it?.presentclass?.classname==icalssname}">
																					<td>
																						${it?.academicyear}
																					</td>
																				</g:if>
																		...
																		<g:if test="${params?.iclass=='all'}">
																			...
																			<g:each in="${studentInstance?.academicyear}">
																				<g:if
																					test="${it?.academicyear==params?.academicyear}">
																					<td>
