	...
	<div class="page-container">
								...
								<div class="crtfcte">
									...
									<div class="row">
										...
										<div class="certificate">
											...
											<g:if test="${issuedToStaff == null}">
											<div class="col-md-12">
												<h4><b>List Of Issued Books to Students .</b></h4>
		...
		<div class="table-scrollable">
			<table class="table  table-hover">
				...
				<tbody>
					<g:each in="${issuedToStudents}" status="i"
						var="issuedInstance">
						<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
							<td>
								${issuedInstance?.studentId?.studentName}
							</td>
							<td>
							...
							${issuedInstance?.dateOfIssue}
											...
											<g:elseif test="${issuedToStudents == null}">
											<div class="col-md-12">
												<h4><b>List Of Issued Books to Staff .</b></h4>
												<div class="portlet-body">
		<div class="table-scrollable">
			<table class="table  table-hover">
				<thead>
