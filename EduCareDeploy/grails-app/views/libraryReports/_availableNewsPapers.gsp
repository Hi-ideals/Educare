...
<div class="portlet box grey">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-user"></i>List Of Available News Papers
		</div>
	</div>
	<div class="portlet-body">
		<div class="table-scrollable">
			<table class="table table-bordered table-hover">
				...
				<tbody>
					<g:each in="${allNewsPapers}" status="i"
						var="newsInstance">
...
<g:link class="btn-u sm-margin-bottom-10 btn blue" controller="libraryReports" action="availableNewsPapersPrint" target='_blank'>Get Print</g:link>
</div>
<%--
