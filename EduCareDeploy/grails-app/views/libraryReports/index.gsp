		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				<g:render template="/header/leftSide"
					model="[activ:[libraryInfo:'start active open',studentList:'active']]"></g:render>
				<!-- END SIDEBAR MENU -->
				<!-- END SIDEBAR MENU -->
			</div>
			<!-- END SIDEBAR -->
									...
									<div class="portlet light bordered">
										...
										<div class="portlet-body form">
											...
											<button class="btn green" id="regclick">
												<i class="icon-magnifier font-white"></i> By Available Books
											</button>
											<button class="btn blue" id="classclick">
												<i class="icon-magnifier font-white"></i> By Issued Books
											</button>
											<button class="btn yellow" id="dateclick">
												<i class="icon-magnifier font-white"></i> By Returned Books
											</button>
											<button class="btn green" id="castclick">
												<i class="icon-magnifier font-white"></i> By Student Wise
											</button>
											<button class="btn green" id="yearclick">
												<i class="icon-magnifier font-white"></i> By Staff Wise
											</button>
											<div class="margin-bottom-10"></div>
											<div id="Reg" style="display: none">
												<g:formRemote name="ss" url="[action:'availableBooks']"
													update="Changedisplay">
													<div class="row">
														<div class="col-md-4">
															<g:submitButton name="Click To Get Available Books"
																class="btn green" style="margin-top: 22px" />
														</div>
													</div>
												</g:formRemote>
												<g:formRemote name="ss" url="[action:'availableNewsPapers']"
													update="Changedisplay">
													<div class="row">
														<div class="col-md-4">
															<g:submitButton name="Click To Get Available NewsPapers"
																class="btn green" style="margin-top: 22px" />
														</div>
													</div>
												</g:formRemote>
												<g:formRemote name="ss" url="[action:'availableMagazines']"
													update="Changedisplay">
													<div class="row">
														<div class="col-md-4">
															<g:submitButton name="Click To Get Available Magazines"
																class="btn green" style="margin-top: 22px" />
														</div>
													</div>
												</g:formRemote>
											...
											<div id="class" style="display: none">
												<g:formRemote name="ss" url="[action:'getByIssuedDate']"
													update="Changedisplay">
													<div class="row">
														<div class="col-md-4">
											...
											<div id="date" style="display: none">
												<g:formRemote name="ss" url="[action:'getByReturnDate']"
													update="Changedisplay">
													<div class="row">
														<div class="col-md-4">
															<label>Select Options</label> <select name="type"
														...
														<div class="col-md-4">
															<label>From</label> <input type="text" name="from"
																id="datepicker2" class="form-control date-picker">
														</div>
														<div class="col-md-4">
															<label>To</label> <input type="text" name="to"
																id="datepicker3" class="form-control date-picker"
																value="${params.to }">
														</div>
											...
											<div id="cast" style="display: none">
												<g:formRemote name="sscast" url="[action:'studentWise']"
													update="Changedisplay">
													<div class="row">

														<div class="col-md-4">
															<label>Enter Student Name</label> <input type="text"
																class="form-control" name="stName"
											...
											<div id="yearclass" style="display: none">
												<g:formRemote name="kk" url="[action:'staffWise']"
													update="Changedisplay">
