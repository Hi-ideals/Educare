								...
								<div class="crtfcte">
									...
									<div class="row">
										...
										<div class="certificate">
											...
											<g:if test="${staffreturnDate == null}">
												<div class="col-md-12">
													<h4>
														<b>List Of Return Books From Students .</b>
													</h4>
													<div class="portlet-body">
														<div class="table-scrollable">
															<table class="table  table-hover">
																...
																<tbody>
																	<g:each in="${streturnDate}" status="i"
																		var="returnInstance">
																		<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
																			<td>
																				${returnInstance?.studentId?.studentName}
																			</td>
																			<td>
											...
											<g:elseif test="${streturnDate == null}">
												<div class="col-md-12">
													<h4>
														<b>List Of Return Books From Staff .</b>
													</h4>
													<div class="portlet-body">
														<div class="table-scrollable">
															<table class="table  table-hover">
