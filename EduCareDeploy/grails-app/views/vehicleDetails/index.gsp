				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><i class="fa fa-circle"></i> <g:link class="create"
								action="create">Create Vehicle</g:link></li>
					</ul>
				</div>
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<div id="list-vehicleDetails" class="content scaffold-list"
									role="main">
									...
									<div class="portlet box grey">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-bus"></i>Lists of Vehicles
											</div>
										</div>
													...
													<tbody>
														<g:each in="${vehicleDetailsInstanceList}" status="i"
															...
															<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
																...
																<li>
																<g:link action="show"
																		id="${LookUpED.encod(vehicleDetailsInstance.id)}"> <i class="fa fa-eye"></i> View</g:link>
																</li>
																<li>
																<g:form
									...
									<div style="text-align: center;">
										<ul class="pagination">
											<li><g:paginate
													total="${vehicleDetailsInstanceCount ?: 0}" /></li>
										</ul>
									</div>
								</div>
							</div>
