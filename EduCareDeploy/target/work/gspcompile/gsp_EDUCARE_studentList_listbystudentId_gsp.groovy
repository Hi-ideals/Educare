...
class gsp_EDUCARE_studentList_listbystudentId_gsp extends GroovyPage {
...
printHtmlPart(23)
for( _it1808774497 in (studentInstance?.academicyear) ) {
changeItVariable(_it1808774497)
printHtmlPart(24)
...
printHtmlPart(27)
for( _it1918150282 in (studentInstance?.academicyear) ) {
changeItVariable(_it1918150282)
printHtmlPart(24)
if(true && (it.status == 'current')) {
printHtmlPart(24)
}
