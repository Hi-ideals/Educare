...
class gsp_EDUCARE_studentstudentIdss_gsp extends GroovyPage {
...
if(true && (student)) {
printHtmlPart(5)
for( _it998575031 in (student) ) {
changeItVariable(_it998575031)
printHtmlPart(6)
...
printHtmlPart(21)
for( _it1745010958 in (student?.academicyear) ) {
changeItVariable(_it1745010958)
printHtmlPart(22)
...
printHtmlPart(25)
for( _it874023329 in (student?.academicyear) ) {
changeItVariable(_it874023329)
printHtmlPart(22)
if(true && (it.status == 'current')) {
printHtmlPart(22)
}
...
printHtmlPart(27)
for( _it694762269 in (student?.academicyear) ) {
changeItVariable(_it694762269)
printHtmlPart(12)
if(true && (it.status == 'current')) {
printHtmlPart(12)
}
...
printHtmlPart(21)
for( _it975328564 in (p?.academicyear) ) {
changeItVariable(_it975328564)
printHtmlPart(22)
if(true && (it.status == 'current')) {
printHtmlPart(22)
}
...
expressionOut.print(pclass.classname)
printHtmlPart(25)
for( _it1154939343 in (p?.academicyear) ) {
changeItVariable(_it1154939343)
printHtmlPart(22)
if(true && (it.status == 'current')) {
printHtmlPart(22)
}
...
printHtmlPart(27)
for( _it888350069 in (p?.academicyear) ) {
changeItVariable(_it888350069)
printHtmlPart(12)
if(true && (it.status == 'current')) {
printHtmlPart(12)
}
