...
class gsp_EDUCARE_listofFeesgetOndatefeereportprint_gsp extends GroovyPage {
...
printHtmlPart(18)
for( _it799150815 in (arryl[i]?.academicyear) ) {
...
printHtmlPart(21)
for( _it1022927413 in (arryl[i]?.academicyear) ) {
changeItVariable(_it1022927413)
printHtmlPart(19)
if(true && (it.status == 'current')) {
printHtmlPart(19)
}
