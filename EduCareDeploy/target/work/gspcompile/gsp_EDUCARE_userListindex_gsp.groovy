...
class gsp_EDUCARE_userListindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/userList/index.gsp" }
public Object run() {
Writer out = getOut()
...
loop:{
int i = 0
for( userListInstance in (userListInstanceList) ) {
printHtmlPart(15)
expressionOut.print((i % 2) == 0 ? 'even' : 'odd')
printHtmlPart(16)
expressionOut.print(fieldValue(bean: userListInstance, field: "userName"))
printHtmlPart(17)
invokeTag('formatDate','g',126,['date':(userListInstance.dateCreated),'format':("dd-MMM-yyyy")],-1)
printHtmlPart(18)
createClosureForHtmlPart(19, 3)
invokeTag('link','g',128,['action':("show"),'id':(LookUpED.encod(userListInstance.id))],3)
printHtmlPart(20)
i++
}
}
printHtmlPart(21)
invokeTag('paginate','g',134,['total':(userListInstanceCount ?: 0)],-1)
printHtmlPart(22)
...
public static final long LAST_MODIFIED = 1628926005281L
