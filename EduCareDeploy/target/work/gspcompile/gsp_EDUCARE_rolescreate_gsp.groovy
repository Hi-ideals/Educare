...
class gsp_EDUCARE_rolescreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/roles/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',105,['bean':(rolesInstance),'var':("error")],3)
printHtmlPart(21)
})
invokeTag('hasErrors','g',107,['bean':(rolesInstance)],2)
printHtmlPart(14)
createTagBody(2, {->
printHtmlPart(22)
invokeTag('render','g',110,['template':("form")],-1)
printHtmlPart(23)
invokeTag('submitButton','g',115,['name':("create"),'class':("btn btn-primary"),'id':("createrole"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(24)
})
invokeTag('form','g',117,['url':([resource:rolesInstance, action:'save'])],2)
printHtmlPart(25)
...
public static final long LAST_MODIFIED = 1628925995257L
