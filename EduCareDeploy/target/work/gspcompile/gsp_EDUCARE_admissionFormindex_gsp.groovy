...
class gsp_EDUCARE_admissionFormindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/admissionForm/index.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(4)
invokeTag('render','g',43,['template':("/header/logo")],-1)
printHtmlPart(5)
invokeTag('render','g',46,['template':("/header/topBar")],-1)
printHtmlPart(6)
invokeTag('render','g',53,['template':("/header/leftSide")],-1)
printHtmlPart(7)
invokeTag('render','g',328,['template':("/footer/footer")],-1)
printHtmlPart(8)
})
invokeTag('captureBody','sitemesh',355,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(9)
}
...
public static final long LAST_MODIFIED = 1628926016176L
