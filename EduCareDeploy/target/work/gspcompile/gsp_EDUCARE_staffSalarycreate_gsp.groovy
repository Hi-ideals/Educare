...
class gsp_EDUCARE_staffSalarycreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/staffSalary/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(6)
invokeTag('render','g',73,['template':("/header/leftSide"),'model':([activ:[payroll:'start active open',staffcreate:'active']])],-1)
printHtmlPart(7)
expressionOut.print(createLink(uri: '/'))
printHtmlPart(8)
invokeTag('message','g',84,['code':("default.home.label")],-1)
printHtmlPart(9)
...
printHtmlPart(19)
invokeTag('message','g',101,['error':(error)],-1)
printHtmlPart(20)
})
invokeTag('eachError','g',102,['bean':(booksInstance),'var':("error")],3)
printHtmlPart(21)
})
invokeTag('hasErrors','g',104,['bean':(booksInstance)],2)
printHtmlPart(22)
createTagBody(2, {->
printHtmlPart(23)
invokeTag('render','g',117,['template':("form")],-1)
printHtmlPart(24)
invokeTag('submitButton','g',121,['name':("create"),'class':("save btn blue"),'id':("staffSalary"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(25)
})
invokeTag('form','g',123,['url':([resource:staffSalaryInstance, action:'save'])],2)
printHtmlPart(26)
...
public static final long LAST_MODIFIED = 1628926006226L
