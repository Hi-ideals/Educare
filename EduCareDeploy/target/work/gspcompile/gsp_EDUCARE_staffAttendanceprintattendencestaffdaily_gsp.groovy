...
class gsp_EDUCARE_staffAttendanceprintattendencestaffdaily_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/staffAttendance/printattendencestaffdaily.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(19)
invokeTag('set','g',158,['var':("Atendancedates"),'value':(staffAttendanceList.getAt(st1))],-1)
printHtmlPart(20)
invokeTag('set','g',159,['var':("date"),'value':("1")],-1)
printHtmlPart(20)
invokeTag('set','g',160,['var':("adMap"),'value':([:])],-1)
printHtmlPart(20)
...
expressionOut.print(att)
printHtmlPart(28)
invokeTag('set','g',187,['var':("date"),'value':(Integer.parseInt(date.toString())+1)],-1)
printHtmlPart(29)
if(true && (Atendancedates.getAt(att)=='P')) {
printHtmlPart(30)
expressionOut.print(Atendancedates.getAt(att))
...
printHtmlPart(21)
invokeTag('set','g',202,['var':("date"),'value':(Integer.parseInt(date.toString())+1)],-1)
printHtmlPart(20)
}
printHtmlPart(34)
k++
...
printHtmlPart(36)
invokeTag('render','g',263,['template':("/footer/footer")],-1)
printHtmlPart(37)
})
invokeTag('captureBody','sitemesh',287,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(38)
}
...
public static final long LAST_MODIFIED = 1628926011457L
