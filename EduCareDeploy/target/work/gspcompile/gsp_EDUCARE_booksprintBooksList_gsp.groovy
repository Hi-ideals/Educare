...
class gsp_EDUCARE_booksprintBooksList_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/books/printBooksList.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(18)
expressionOut.print(fieldValue(bean: booksInstance, field: "subject"))
printHtmlPart(18)
expressionOut.print(fieldValue(bean: booksInstance, field: "edition"))
printHtmlPart(18)
expressionOut.print(fieldValue(bean: booksInstance, field: "volume"))
printHtmlPart(19)
i++
}
}
printHtmlPart(20)
invokeTag('render','g',241,['template':("/footer/footer")],-1)
printHtmlPart(21)
})
invokeTag('captureBody','sitemesh',279,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(22)
}
...
public static final long LAST_MODIFIED = 1628925994056L
