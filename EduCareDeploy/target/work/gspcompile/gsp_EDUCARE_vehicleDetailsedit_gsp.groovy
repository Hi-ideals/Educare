...
class gsp_EDUCARE_vehicleDetailsedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/vehicleDetails/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',81,['template':("/header/leftSide"),'model':([activ:[TransportManagement:'start active open',AddVechile:'active']])],-1)
printHtmlPart(8)
...
invokeTag('eachError','g',123,['bean':(vehicleDetailsInstance),'var':("error")],3)
printHtmlPart(24)
})
invokeTag('hasErrors','g',125,['bean':(vehicleDetailsInstance)],2)
printHtmlPart(25)
createTagBody(2, {->
printHtmlPart(26)
invokeTag('hiddenField','g',141,['name':("version"),'value':(vehicleDetailsInstance?.version)],-1)
printHtmlPart(27)
invokeTag('render','g',143,['template':("form")],-1)
printHtmlPart(28)
invokeTag('actionSubmit','g',149,['class':("save btn blue"),'action':("update"),'id':("vehicleDetails"),'value':(message(code: 'default.button.update.label', default: 'Update'))],-1)
printHtmlPart(29)
})
invokeTag('form','g',151,['url':([resource:vehicleDetailsInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(30)
...
public static final long LAST_MODIFIED = 1628926019593L
