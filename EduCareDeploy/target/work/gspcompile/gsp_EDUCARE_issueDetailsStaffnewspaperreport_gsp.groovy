...
class gsp_EDUCARE_issueDetailsStaffnewspaperreport_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/issueDetailsStaff/newspaperreport.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',141,['controller':("IssueDetailsStaff"),'action':("returned1")],3)
printHtmlPart(18)
j++
}
}
...
public static final long LAST_MODIFIED = 1628925995152L
