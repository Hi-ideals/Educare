...
class gsp_EDUCARE_listofStudentsgetByClass_gsp extends GroovyPage {
...
printHtmlPart(32)
for( _it1827573818 in (studentInstance?.academicyear) ) {
changeItVariable(_it1827573818)
printHtmlPart(33)
...
printHtmlPart(39)
for( _it2014241709 in (studentInstance?.academicyear) ) {
changeItVariable(_it2014241709)
printHtmlPart(40)
