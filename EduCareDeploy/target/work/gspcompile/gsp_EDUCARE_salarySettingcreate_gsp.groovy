...
class gsp_EDUCARE_salarySettingcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/salarySetting/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(25)
invokeTag('submitButton','g',137,['name':("create"),'class':("save btn blue"),'id':("salarySetting"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(26)
})
invokeTag('form','g',139,['url':([resource:salarySettingInstance, action:'save'])],2)
printHtmlPart(27)
invokeTag('render','g',152,['template':("/footer/footer")],-1)
printHtmlPart(28)
})
invokeTag('captureBody','sitemesh',191,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(29)
}
...
public static final long LAST_MODIFIED = 1628926010733L
