...
class gsp_EDUCARE_newspapercreate_gsp extends GroovyPage {
...
printHtmlPart(7)
invokeTag('render','g',80,['template':("/header/leftSide"),'model':([activ:[LibraryManagement:'start active open',newspaper:'active']])],-1)
printHtmlPart(8)
...
invokeTag('eachError','g',117,['bean':(newspaperInstance),'var':("error")],3)
printHtmlPart(22)
})
invokeTag('hasErrors','g',119,['bean':(newspaperInstance)],2)
printHtmlPart(23)
createTagBody(2, {->
printHtmlPart(24)
invokeTag('render','g',133,['template':("form")],-1)
printHtmlPart(25)
invokeTag('submitButton','g',137,['name':("create"),'class':("btn blue"),'id':("newspaper"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(26)
})
invokeTag('form','g',139,['url':([resource:newspaperInstance, action:'save'])],2)
printHtmlPart(27)
...
public static final long LAST_MODIFIED = 1628925993982L
