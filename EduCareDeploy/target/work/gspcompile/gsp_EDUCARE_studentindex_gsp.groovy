...
class gsp_EDUCARE_studentindex_gsp extends GroovyPage {
...
printHtmlPart(14)
invokeTag('render','g',103,['template':("/student/studentlistable")],-1)
printHtmlPart(15)
invokeTag('paginate','g',109,['total':(studentInstanceCount ?: 0)],-1)
printHtmlPart(16)
invokeTag('render','g',120,['template':("/footer/footer")],-1)
printHtmlPart(17)
})
...
public static final long LAST_MODIFIED = 1628926000655L
