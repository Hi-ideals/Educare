...
class gsp_EDUCARE_transportcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/transport/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',80,['template':("/header/leftSide"),'model':([activ:[TransportManagement:'start active open',Transport:'active']])],-1)
printHtmlPart(8)
...
invokeTag('link','g',102,['class':("list"),'action':("index")],2)
printHtmlPart(12)
...
invokeTag('eachError','g',119,['bean':(transportInstance),'var':("error")],3)
printHtmlPart(22)
})
invokeTag('hasErrors','g',121,['bean':(transportInstance)],2)
printHtmlPart(23)
createTagBody(2, {->
printHtmlPart(24)
invokeTag('render','g',135,['template':("form")],-1)
printHtmlPart(25)
invokeTag('submitButton','g',140,['name':("create"),'class':("save btn blue"),'id':("transportInstance"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(26)
})
invokeTag('form','g',142,['url':([resource:transportInstance, action:'save'])],2)
printHtmlPart(27)
...
public static final long LAST_MODIFIED = 1628926011960L
