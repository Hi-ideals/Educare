...
class gsp_EDUCARE_issueDetailsStaffstaffnewspaperprintone_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/issueDetailsStaff/staffnewspaperprintone.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(18)
invokeTag('formatDate','g',162,['date':(c?.issuedate),'type':("date"),'style':("SHORT")],-1)
printHtmlPart(19)
invokeTag('formatDate','g',164,['date':(c?.returndate),'type':("date"),'style':("SHORT")],-1)
printHtmlPart(20)
...
printHtmlPart(22)
invokeTag('render','g',223,['template':("/footer/footer")],-1)
printHtmlPart(23)
})
...
public static final long LAST_MODIFIED = 1628925995180L
