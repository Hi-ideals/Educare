...
class gsp_ROOT_studentspecificfeeprint_gsp extends GroovyPage {
...
printHtmlPart(18)
for( _it1379580841 in (studentInstance?.academicyear) ) {
changeItVariable(_it1379580841)
printHtmlPart(9)
...
printHtmlPart(21)
for( _it1846086314 in (studentInstance?.academicyear) ) {
changeItVariable(_it1846086314)
printHtmlPart(9)
if(true && (it.status == 'current')) {
printHtmlPart(9)
}
...
printHtmlPart(28)
for( _it366451568 in (studentInstance?.academicyear) ) {
