...
class gsp_EDUCARE_staffSalaryedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/staffSalary/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',79,['template':("/header/leftSide"),'model':([activ:[payroll:'start active open',staffcreate:'active']])],-1)
printHtmlPart(8)
...
invokeTag('eachError','g',119,['bean':(subjectInstance),'var':("error")],3)
printHtmlPart(21)
})
invokeTag('hasErrors','g',121,['bean':(subjectInstance)],2)
printHtmlPart(22)
createTagBody(2, {->
printHtmlPart(23)
invokeTag('hiddenField','g',137,['name':("version"),'value':(staffSalaryInstance?.version)],-1)
printHtmlPart(24)
invokeTag('render','g',139,['template':("form")],-1)
printHtmlPart(25)
invokeTag('actionSubmit','g',145,['class':("save btn blue"),'action':("update"),'id':("staffSalary"),'value':(message(code: 'default.button.update.label', default: 'Update'))],-1)
printHtmlPart(26)
})
invokeTag('form','g',147,['url':([resource:staffSalaryInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(27)
...
public static final long LAST_MODIFIED = 1628926006244L
