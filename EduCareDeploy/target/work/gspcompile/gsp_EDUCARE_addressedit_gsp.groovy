...
class gsp_EDUCARE_addressedit_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(10)
invokeTag('message','g',79,['code':("default.list.label"),'args':([entityName])],-1)
printHtmlPart(11)
})
...
printHtmlPart(21)
invokeTag('message','g',97,['error':(error)],-1)
printHtmlPart(22)
})
invokeTag('eachError','g',98,['bean':(addressInstance),'var':("error")],3)
printHtmlPart(23)
})
invokeTag('hasErrors','g',100,['bean':(addressInstance)],2)
printHtmlPart(24)
createTagBody(2, {->
printHtmlPart(10)
invokeTag('hiddenField','g',114,['name':("version"),'value':(addressInstance?.version)],-1)
printHtmlPart(25)
invokeTag('render','g',116,['template':("form")],-1)
printHtmlPart(26)
invokeTag('actionSubmit','g',120,['class':("btn blue"),'action':("update"),'value':(message(code: 'default.button.update.label', default: 'Update'))],-1)
printHtmlPart(27)
})
invokeTag('form','g',122,['url':([resource:addressInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(28)
...
public static final long LAST_MODIFIED = 1628926020360L
