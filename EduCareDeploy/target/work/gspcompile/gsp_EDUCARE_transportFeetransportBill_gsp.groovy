...
class gsp_EDUCARE_transportFeetransportBill_gsp extends GroovyPage {
...
printHtmlPart(24)
for( _it1533987146 in (transportFeeInstanceList?.student?.academicyear[0]) ) {
changeItVariable(_it1533987146)
printHtmlPart(20)
...
printHtmlPart(26)
for( _it1685344880 in (transportFeeInstanceList?.student?.academicyear[0]) ) {
changeItVariable(_it1685344880)
printHtmlPart(20)
if(true && (it.status == 'current')) {
printHtmlPart(20)
}
...
printHtmlPart(33)
for( _it1500321780 in (transportFeeInstanceList?.student?.academicyear[0]) ) {
changeItVariable(_it1500321780)
printHtmlPart(20)
if(true && (it.status == 'current')) {
printHtmlPart(20)
}
