...
class gsp_EDUCARE_studycertificateindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/studycertificate/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',93,['template':("/header/leftSide"),'model':([activ:[Certificates:'start active open',studycertificate:'active']])],-1)
printHtmlPart(8)
...
printHtmlPart(16)
invokeTag('submitButton','g',177,['name':("Search"),'class':("btn green"),'id':("bonafied"),'style':("margin-top: 22px")],-1)
printHtmlPart(17)
})
invokeTag('formRemote','g',181,['name':("ssss"),'url':([action:'aaaa']),'update':("Changedisplay")],2)
printHtmlPart(18)
invokeTag('render','g',187,['template':("/studycertificate/studyDisplay")],-1)
printHtmlPart(19)
...
public static final long LAST_MODIFIED = 1628925998972L
