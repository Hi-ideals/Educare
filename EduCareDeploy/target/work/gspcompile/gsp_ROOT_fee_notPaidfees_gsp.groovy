...
class gsp_ROOT_fee_notPaidfees_gsp extends GroovyPage {
...
printHtmlPart(14)
for( _it2001493596 in (st?.academicyear) ) {
changeItVariable(_it2001493596)
printHtmlPart(15)
...
printHtmlPart(18)
for( _it1290804289 in (st?.academicyear) ) {
changeItVariable(_it1290804289)
printHtmlPart(15)
if(true && (it.status == 'current')) {
printHtmlPart(15)
}
