...
class gsp_EDUCARE_libraryReportsgetByReturnDatePrint_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/libraryReports/getByReturnDatePrint.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(15)
if(true && (staffreturnDate == null)) {
printHtmlPart(16)
loop:{
int i = 0
for( returnInstance in (streturnDate) ) {
printHtmlPart(17)
expressionOut.print((i % 2) == 0 ? 'even' : 'odd')
printHtmlPart(18)
expressionOut.print(returnInstance?.studentId?.studentName)
printHtmlPart(19)
...
else if(true && (streturnDate == null)) {
printHtmlPart(22)
loop:{
int i = 0
...
printHtmlPart(23)
invokeTag('render','g',254,['template':("/footer/footer")],-1)
printHtmlPart(24)
})
invokeTag('captureBody','sitemesh',292,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(25)
}
...
public static final long LAST_MODIFIED = 1628925999747L
