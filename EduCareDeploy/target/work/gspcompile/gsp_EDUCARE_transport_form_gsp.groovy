...
class gsp_EDUCARE_transport_form_gsp extends GroovyPage {
...
printHtmlPart(9)
for( _it275139645 in (rut) ) {
changeItVariable(_it275139645)
printHtmlPart(3)
...
printHtmlPart(16)
for( _it2041127543 in (dst) ) {
changeItVariable(_it2041127543)
printHtmlPart(3)
expressionOut.print(it?.id)
printHtmlPart(10)
...
printHtmlPart(25)
for( _it1997725558 in (transportInstance.constraints.type.inList) ) {
changeItVariable(_it1997725558)
printHtmlPart(3)
...
printHtmlPart(30)
for( _it244886962 in (classes) ) {
changeItVariable(_it244886962)
printHtmlPart(31)
expressionOut.print(it?.id)
printHtmlPart(32)
...
printHtmlPart(38)
for( _it742199288 in (com.hiideals.institute.staff.Staff.list()) ) {
changeItVariable(_it742199288)
printHtmlPart(31)
expressionOut.print(it?.id)
printHtmlPart(32)
