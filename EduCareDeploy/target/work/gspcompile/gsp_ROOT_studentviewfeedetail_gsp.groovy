...
class gsp_ROOT_studentviewfeedetail_gsp extends GroovyPage {
...
printHtmlPart(18)
for( _it2077970199 in (stdetails?.academicyear) ) {
...
printHtmlPart(21)
for( _it2005232837 in (studentInstance?.academicyear) ) {
...
printHtmlPart(23)
for( _it33281504 in (stdetails?.academicyear) ) {
