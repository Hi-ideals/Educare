...
class gsp_EDUCARE_payHeadcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/payHead/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',80,['template':("/header/leftSide"),'model':([activ:[payroll:'start active open',payheadcreate:'active']])],-1)
printHtmlPart(8)
...
invokeTag('eachError','g',114,['bean':(booksInstance),'var':("error")],3)
printHtmlPart(22)
})
invokeTag('hasErrors','g',116,['bean':(booksInstance)],2)
printHtmlPart(23)
createTagBody(2, {->
printHtmlPart(24)
invokeTag('render','g',129,['template':("form")],-1)
printHtmlPart(25)
invokeTag('submitButton','g',135,['name':("create"),'class':("save btn blue"),'id':("payHead"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(26)
})
invokeTag('form','g',137,['url':([resource:payHeadInstance, action:'save'])],2)
printHtmlPart(27)
invokeTag('render','g',147,['template':("/footer/footer")],-1)
printHtmlPart(28)
})
...
public static final long LAST_MODIFIED = 1628925998573L
