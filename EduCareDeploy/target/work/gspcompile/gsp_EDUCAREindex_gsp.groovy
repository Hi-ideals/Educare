...
class gsp_EDUCAREindex_gsp extends GroovyPage {
...
invokeTag('link','g',86,['controller':("login"),'action':("auth")],2)
printHtmlPart(7)
})
invokeTag('captureBody','sitemesh',329,['class':("page-container-bg-solid page-header-top-fixed page-boxed")],1)
printHtmlPart(8)
}
...
public static final long LAST_MODIFIED = 1628925993247L
