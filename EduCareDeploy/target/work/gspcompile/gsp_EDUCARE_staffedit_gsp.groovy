...
class gsp_EDUCARE_staffedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/staff/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',78,['template':("/header/leftSide"),'model':([activ:[staff:'start active open',staffList:'active']])],-1)
printHtmlPart(8)
expressionOut.print(createLink(uri: '/'))
printHtmlPart(9)
createClosureForHtmlPart(10, 2)
invokeTag('link','g',94,['action':("index")],2)
printHtmlPart(11)
...
printHtmlPart(19)
invokeTag('message','g',117,['error':(error)],-1)
printHtmlPart(20)
})
invokeTag('eachError','g',118,['bean':(staffInstance),'var':("error")],3)
printHtmlPart(21)
})
invokeTag('hasErrors','g',120,['bean':(staffInstance)],2)
printHtmlPart(22)
createTagBody(2, {->
printHtmlPart(23)
invokeTag('hiddenField','g',134,['name':("version"),'value':(staffInstance?.version)],-1)
printHtmlPart(24)
invokeTag('render','g',136,['template':("form")],-1)
printHtmlPart(25)
invokeTag('actionSubmit','g',141,['class':("btn blue"),'action':("update"),'id':("CreateStaf"),'value':(message(code: 'default.button.update.label', default: 'Update'))],-1)
printHtmlPart(26)
})
invokeTag('form','g',143,['url':([resource:staffInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(27)
...
public static final long LAST_MODIFIED = 1628926002868L
