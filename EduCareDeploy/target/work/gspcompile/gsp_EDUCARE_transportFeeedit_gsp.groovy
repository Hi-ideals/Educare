...
class gsp_EDUCARE_transportFeeedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/transportFee/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',81,['template':("/header/leftSide"),'model':([activ:[TransportManagement:'start active open',TransportFee:'active']])],-1)
printHtmlPart(8)
...
invokeTag('eachError','g',123,['bean':(transportFeeInstance),'var':("error")],3)
printHtmlPart(24)
})
invokeTag('hasErrors','g',125,['bean':(transportFeeInstance)],2)
printHtmlPart(25)
createTagBody(2, {->
printHtmlPart(26)
invokeTag('hiddenField','g',139,['name':("version"),'value':(transportFeeInstance?.version)],-1)
printHtmlPart(27)
invokeTag('render','g',141,['template':("form")],-1)
printHtmlPart(28)
invokeTag('actionSubmit','g',146,['class':("save btn blue"),'action':("update"),'id':("transportFee"),'value':(message(code: 'default.button.update.label', default: 'Update'))],-1)
printHtmlPart(29)
})
invokeTag('form','g',148,['url':([resource:transportFeeInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(30)
...
public static final long LAST_MODIFIED = 1628926005860L
