...
class gsp_EDUCARE_booksedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/books/edit.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',97,['bean':(subjectInstance),'var':("error")],3)
printHtmlPart(20)
})
invokeTag('hasErrors','g',99,['bean':(subjectInstance)],2)
printHtmlPart(21)
createTagBody(2, {->
printHtmlPart(22)
invokeTag('hiddenField','g',113,['name':("version"),'value':(booksInstance?.version)],-1)
printHtmlPart(23)
invokeTag('render','g',115,['template':("form")],-1)
printHtmlPart(24)
invokeTag('actionSubmit','g',120,['class':("save blue btn"),'action':("update"),'id':("books"),'value':(message(code: 'default.button.update.label', default: 'Update'))],-1)
printHtmlPart(25)
})
invokeTag('form','g',122,['url':([resource:booksInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(26)
invokeTag('render','g',135,['template':("/footer/footer")],-1)
printHtmlPart(27)
})
invokeTag('captureBody','sitemesh',174,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(28)
}
...
public static final long LAST_MODIFIED = 1628925994051L
