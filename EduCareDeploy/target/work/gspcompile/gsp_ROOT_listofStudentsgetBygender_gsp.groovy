...
class gsp_ROOT_listofStudentsgetBygender_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/listofStudents/getBygender.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(15)
expressionOut.print(params?.genderone)
printHtmlPart(16)
invokeTag('set','g',142,['var':("user"),'value':(sec.username())],-1)
printHtmlPart(17)
if(true && (user == "vidyashree")) {
printHtmlPart(18)
invokeTag('message','g',146,['code':("student.fatherDetails.label"),'default':("Registration Number")],-1)
printHtmlPart(19)
}
else {
printHtmlPart(20)
...
printHtmlPart(21)
invokeTag('message','g',156,['code':("student.guardianDetails.label"),'default':("Student Name")],-1)
printHtmlPart(22)
invokeTag('message','g',161,['code':("student.guardianDetails.label"),'default':("Class ")],-1)
printHtmlPart(23)
loop:{
int i = 0
...
printHtmlPart(25)
invokeTag('set','g',173,['var':("user"),'value':(sec.username())],-1)
printHtmlPart(17)
if(true && (user == "vidyashree")) {
printHtmlPart(26)
}
...
printHtmlPart(31)
for( _it108849833 in (studentInstance?.academicyear) ) {
changeItVariable(_it108849833)
printHtmlPart(32)
...
printHtmlPart(11)
invokeTag('set','g',191,['value':(it?.presentclass),'var':("pclass")],-1)
printHtmlPart(33)
expressionOut.print(pclass.classname)
printHtmlPart(34)
for( _it1051130608 in (studentInstance?.academicyear) ) {
changeItVariable(_it1051130608)
printHtmlPart(32)
if(true && (it.status == 'current')) {
printHtmlPart(32)
}
...
printHtmlPart(11)
invokeTag('set','g',196,['value':(it?.section),'var':("pclass")],-1)
printHtmlPart(33)
expressionOut.print(pclass.sectionName)
printHtmlPart(35)
expressionOut.print(fieldValue(bean: studentInstance, field: "gender"))
printHtmlPart(31)
invokeTag('formatDate','g',202,['format':("dd-MMM-yyyy"),'date':(studentInstance.studentDOJ)],-1)
printHtmlPart(36)
i++
}
}
...
public static final long LAST_MODIFIED = 1628926010914L
