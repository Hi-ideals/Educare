...
class gsp_EDUCARE_routeDetailsindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/routeDetails/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',77,['template':("/header/leftSide"),'model':([activ:[TransportManagement:'start active open',RouteDetails:'active']])],-1)
printHtmlPart(8)
...
invokeTag('link','g',151,['action':("show"),'id':(LookUpED.encod(routeDetailsInstance.id))],3)
printHtmlPart(21)
createTagBody(3, {->
printHtmlPart(22)
createTagBody(4, {->
printHtmlPart(23)
invokeTag('message','g',160,['code':("default.button.edit.label"),'default':("Edit")],-1)
printHtmlPart(24)
})
invokeTag('link','g',161,['action':("edit"),'id':(LookUpED.encod(routeDetailsInstance.id))],4)
printHtmlPart(25)
})
invokeTag('form','g',163,['url':([resource:routeDetailsInstance, action:'delete']),'method':("DELETE")],3)
printHtmlPart(26)
i++
}
}
printHtmlPart(27)
invokeTag('paginate','g',170,['total':(routeDetailsInstanceCount ?: 0)],-1)
printHtmlPart(28)
...
public static final long LAST_MODIFIED = 1628926003636L
