...
class gsp_EDUCARE_transportReportavailableDriversPrint_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/transportReport/availableDriversPrint.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(21)
invokeTag('formatDate','g',165,['format':("MMM-dd-yyyy"),'date':(driverDetailsInstance.dob)],-1)
printHtmlPart(22)
...
printHtmlPart(24)
invokeTag('render','g',228,['template':("/footer/footer")],-1)
printHtmlPart(25)
})
invokeTag('captureBody','sitemesh',266,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(26)
}
...
public static final long LAST_MODIFIED = 1628925995459L
