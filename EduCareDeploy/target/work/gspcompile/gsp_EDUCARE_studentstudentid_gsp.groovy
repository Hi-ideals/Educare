...
class gsp_EDUCARE_studentstudentid_gsp extends GroovyPage {
...
printHtmlPart(24)
for( _it254493443 in (studentInstance?.academicyear) ) {
changeItVariable(_it254493443)
printHtmlPart(23)
...
printHtmlPart(31)
for( _it601728931 in (studentInstance?.academicyear) ) {
changeItVariable(_it601728931)
printHtmlPart(25)
if(true && (it.status == 'current')) {
printHtmlPart(25)
}
...
printHtmlPart(39)
for( _it758750856 in (studentInstance?.academicyear) ) {
changeItVariable(_it758750856)
printHtmlPart(25)
if(true && (it.status == 'current')) {
printHtmlPart(25)
}
...
printHtmlPart(73)
for( _it403937859 in (rut) ) {
changeItVariable(_it403937859)
printHtmlPart(74)
...
printHtmlPart(80)
for( _it1307963673 in (dst) ) {
changeItVariable(_it1307963673)
printHtmlPart(74)
expressionOut.print(it?.id)
printHtmlPart(75)
