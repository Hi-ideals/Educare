...
class gsp_EDUCARE_studenttransfer_gsp extends GroovyPage {
...
printHtmlPart(25)
for( _it1694558342 in (student?.academicyear) ) {
changeItVariable(_it1694558342)
printHtmlPart(1)
...
printHtmlPart(27)
for( _it571349883 in (student?.academicyear) ) {
changeItVariable(_it571349883)
printHtmlPart(1)
if(true && (it.status == 'current')) {
printHtmlPart(1)
}
...
printHtmlPart(29)
for( _it1425889113 in (student.academicyear) ) {
changeItVariable(_it1425889113)
printHtmlPart(30)
if(true && (it.status == 'current')) {
printHtmlPart(30)
}
