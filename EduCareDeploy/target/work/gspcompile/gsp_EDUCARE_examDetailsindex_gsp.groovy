...
class gsp_EDUCARE_examDetailsindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/examDetails/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',77,['template':("/header/leftSide"),'model':([activ:[exams:'start active open',examDetails:'active']])],-1)
printHtmlPart(8)
...
loop:{
int i = 0
for( examDetailsInstance in (examDetailsInstanceList) ) {
printHtmlPart(16)
expressionOut.print((i % 2) == 0 ? 'even' : 'odd')
printHtmlPart(17)
invokeTag('formatDate','g',138,['date':(examDetailsInstance?.examDate),'type':("date"),'style':("LONG"),'timeStyle':("SHORT")],-1)
printHtmlPart(18)
...
invokeTag('link','g',163,['action':("show"),'id':(LookUpED.encod(examDetailsInstance.id))],3)
printHtmlPart(23)
i++
}
}
printHtmlPart(24)
invokeTag('paginate','g',172,['total':(examDetailsInstanceCount ?: 0)],-1)
printHtmlPart(25)
invokeTag('render','g',182,['template':("/footer/footer")],-1)
printHtmlPart(26)
})
...
public static final long LAST_MODIFIED = 1628926001967L
