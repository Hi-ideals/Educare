...
class gsp_EDUCARE_newspaperedit_gsp extends GroovyPage {
...
printHtmlPart(7)
invokeTag('render','g',81,['template':("/header/leftSide"),'model':([activ:[LibraryManagement:'start active open',newspaper:'active']])],-1)
printHtmlPart(8)
...
invokeTag('link','g',104,['class':("create"),'action':("create")],2)
printHtmlPart(14)
...
invokeTag('eachError','g',125,['bean':(newspaperInstance),'var':("error")],3)
printHtmlPart(24)
})
invokeTag('hasErrors','g',127,['bean':(newspaperInstance)],2)
printHtmlPart(25)
createTagBody(2, {->
printHtmlPart(26)
invokeTag('hiddenField','g',141,['name':("version"),'value':(newspaperInstance?.version)],-1)
printHtmlPart(27)
invokeTag('render','g',143,['template':("form")],-1)
printHtmlPart(28)
invokeTag('actionSubmit','g',149,['class':("btn blue"),'action':("update"),'id':("newspaper"),'value':(message(code: 'default.button.update.label', default: 'Update'))],-1)
printHtmlPart(29)
})
invokeTag('form','g',151,['url':([resource:newspaperInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(30)
...
public static final long LAST_MODIFIED = 1628925993986L
