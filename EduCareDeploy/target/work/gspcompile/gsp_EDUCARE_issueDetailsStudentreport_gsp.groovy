...
class gsp_EDUCARE_issueDetailsStudentreport_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/issueDetailsStudent/report.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(8)
invokeTag('render','g',80,['template':("/header/leftSide"),'model':([activ:[BooksReport:'start active open',issueDetailsStudentManagine:'active']])],-1)
printHtmlPart(9)
...
printHtmlPart(14)
invokeTag('formatDate','g',137,['date':(c?.issuedate),'type':("date"),'style':("SHORT")],-1)
printHtmlPart(15)
invokeTag('formatDate','g',139,['date':(c?.returndate),'type':("date"),'style':("SHORT")],-1)
printHtmlPart(16)
...
invokeTag('form','g',148,['controller':("IssueDetailsStudent"),'action':("returned")],3)
printHtmlPart(21)
j++
}
}
printHtmlPart(22)
invokeTag('render','g',171,['template':("/footer/footer")],-1)
printHtmlPart(23)
})
...
public static final long LAST_MODIFIED = 1628926004805L
