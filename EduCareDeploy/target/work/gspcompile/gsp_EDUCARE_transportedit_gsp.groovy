...
class gsp_EDUCARE_transportedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/transport/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',81,['template':("/header/leftSide"),'model':([activ:[TransportManagement:'start active open',Transport:'active']])],-1)
printHtmlPart(8)
...
invokeTag('eachError','g',109,['bean':(transportInstance),'var':("error")],3)
printHtmlPart(24)
})
invokeTag('hasErrors','g',111,['bean':(transportInstance)],2)
printHtmlPart(25)
createTagBody(2, {->
printHtmlPart(26)
invokeTag('hiddenField','g',123,['name':("version"),'value':(transportInstance?.version)],-1)
printHtmlPart(27)
invokeTag('render','g',125,['template':("form")],-1)
printHtmlPart(28)
invokeTag('actionSubmit','g',128,['class':("save btn blue"),'id':("transportInstance"),'action':("update"),'value':(message(code: 'default.button.update.label', default: 'Update'))],-1)
printHtmlPart(29)
})
invokeTag('form','g',130,['url':([resource:transportInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(30)
...
public static final long LAST_MODIFIED = 1628926012074L
