...
class gsp_EDUCARE_transportFeecreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/transportFee/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',79,['template':("/header/leftSide"),'model':([activ:[TransportManagement:'start active open',TransportFee:'active']])],-1)
printHtmlPart(8)
...
printHtmlPart(20)
invokeTag('message','g',105,['error':(error)],-1)
printHtmlPart(21)
})
invokeTag('eachError','g',106,['bean':(transportFeeInstance),'var':("error")],3)
printHtmlPart(22)
})
invokeTag('hasErrors','g',108,['bean':(transportFeeInstance)],2)
printHtmlPart(23)
createTagBody(2, {->
printHtmlPart(24)
invokeTag('render','g',122,['template':("form")],-1)
printHtmlPart(25)
invokeTag('submitButton','g',128,['name':("create"),'class':("save btn blue"),'id':("transportFee"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(26)
})
invokeTag('form','g',130,['url':([resource:transportFeeInstance, action:'save'])],2)
printHtmlPart(27)
...
public static final long LAST_MODIFIED = 1628926005837L
