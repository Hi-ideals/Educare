...
class gsp_ROOT_feeedit_gsp extends GroovyPage {
...
printHtmlPart(10)
for( _it1812378044 in (feeInstance?.studentId?.academicyear) ) {
changeItVariable(_it1812378044)
printHtmlPart(11)
...
printHtmlPart(14)
for( _it495828752 in (feeInstance?.studentId?.academicyear) ) {
changeItVariable(_it495828752)
printHtmlPart(11)
if(true && (it.status == 'current')) {
printHtmlPart(11)
}
...
printHtmlPart(15)
for( _it236396435 in (feeInstance?.studentId?.academicyear) ) {
changeItVariable(_it236396435)
printHtmlPart(11)
if(true && (it.status == 'current')) {
printHtmlPart(11)
}
