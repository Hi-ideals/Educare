...
class gsp_EDUCARE_staffAttendancecreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/staffAttendance/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',95,['template':("/header/leftSide"),'model':([activ:[studentAttendance:'start active open',stafftattendancecreate:'active']])],-1)
printHtmlPart(8)
expressionOut.print(createLink(uri: '/'))
printHtmlPart(9)
createClosureForHtmlPart(10, 2)
invokeTag('link','g',111,['controller':("staffAttendance"),'action':("create")],2)
printHtmlPart(11)
...
printHtmlPart(19)
invokeTag('message','g',138,['error':(error)],-1)
printHtmlPart(20)
})
invokeTag('eachError','g',139,['bean':(staffAttendanceInstance),'var':("error")],3)
printHtmlPart(21)
})
invokeTag('hasErrors','g',141,['bean':(staffAttendanceInstance)],2)
printHtmlPart(14)
createTagBody(2, {->
printHtmlPart(22)
invokeTag('render','g',145,['template':("form")],-1)
printHtmlPart(23)
invokeTag('submitButton','g',150,['name':("create"),'class':("btn btn-success btn blue"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(24)
})
invokeTag('form','g',152,['url':([resource:staffAttendanceInstance, action:'getStaffAttendanceSheet'])],2)
printHtmlPart(25)
...
public static final long LAST_MODIFIED = 1628926011349L
