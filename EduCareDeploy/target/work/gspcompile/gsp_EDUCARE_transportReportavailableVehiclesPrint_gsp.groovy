...
class gsp_EDUCARE_transportReportavailableVehiclesPrint_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/transportReport/availableVehiclesPrint.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(19)
invokeTag('formatDate','g',177,['format':("MMM-dd-yyyy"),'date':(vehicleDetailsInstance.insuranceRenewalDate)],-1)
printHtmlPart(20)
i++
}
}
printHtmlPart(21)
invokeTag('render','g',238,['template':("/footer/footer")],-1)
printHtmlPart(22)
})
invokeTag('captureBody','sitemesh',276,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(23)
}
...
public static final long LAST_MODIFIED = 1628925995513L
