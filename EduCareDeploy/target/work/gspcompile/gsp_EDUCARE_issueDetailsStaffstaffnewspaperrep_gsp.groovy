...
class gsp_EDUCARE_issueDetailsStaffstaffnewspaperrep_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/issueDetailsStaff/staffnewspaperrep.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',77,['template':("/header/leftSide"),'model':([activ:[BooksReport:'start active open',issueDetailsStaffNewspaper:'active']])],-1)
printHtmlPart(8)
...
printHtmlPart(13)
invokeTag('formatDate','g',131,['date':(c?.issuedate),'type':("date"),'style':("SHORT")],-1)
printHtmlPart(14)
invokeTag('formatDate','g',133,['date':(c?.returndate),'type':("date"),'style':("SHORT")],-1)
printHtmlPart(15)
j++
}
}
...
public static final long LAST_MODIFIED = 1628925995147L
