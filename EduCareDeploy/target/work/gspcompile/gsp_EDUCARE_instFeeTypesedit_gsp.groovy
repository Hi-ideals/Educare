...
class gsp_EDUCARE_instFeeTypesedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/instFeeTypes/edit.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(25)
invokeTag('hiddenField','g',127,['name':("version"),'value':(instFeeTypesInstance?.version)],-1)
printHtmlPart(26)
invokeTag('render','g',129,['template':("form")],-1)
printHtmlPart(27)
invokeTag('actionSubmit','g',134,['class':("btn blue"),'action':("update"),'id':("createnewfee"),'value':(message(code: 'default.button.update.label', default: 'Update'))],-1)
printHtmlPart(28)
})
invokeTag('form','g',136,['url':([resource:instFeeTypesInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(29)
...
public static final long LAST_MODIFIED = 1628926008251L
