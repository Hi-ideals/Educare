...
class gsp_ROOT_feecreate_gsp extends GroovyPage {
...
printHtmlPart(10)
for( _it590486503 in (student?.academicyear) ) {
changeItVariable(_it590486503)
printHtmlPart(11)
...
printHtmlPart(14)
for( _it1638740214 in (student?.academicyear) ) {
changeItVariable(_it1638740214)
printHtmlPart(11)
if(true && (it.status == 'current')) {
printHtmlPart(11)
}
...
printHtmlPart(15)
for( _it825176144 in (student?.academicyear) ) {
changeItVariable(_it825176144)
printHtmlPart(11)
if(true && (it.status == 'current')) {
printHtmlPart(11)
}
