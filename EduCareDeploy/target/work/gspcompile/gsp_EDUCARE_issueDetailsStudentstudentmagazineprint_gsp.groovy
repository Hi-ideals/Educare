...
class gsp_EDUCARE_issueDetailsStudentstudentmagazineprint_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/issueDetailsStudent/studentmagazineprint.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(18)
invokeTag('formatDate','g',155,['date':(c?.issuedate),'type':("date"),'style':("SHORT")],-1)
printHtmlPart(19)
invokeTag('formatDate','g',157,['date':(c?.returndate),'type':("date"),'style':("SHORT")],-1)
printHtmlPart(20)
...
public static final long LAST_MODIFIED = 1628926004819L
