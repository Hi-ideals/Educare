...
class gsp_ROOT_listofStudents_listofstudenttable_gsp extends GroovyPage {
...
printHtmlPart(19)
for( _it1034296050 in (studentInstance?.academicyear) ) {
changeItVariable(_it1034296050)
printHtmlPart(20)
...
printHtmlPart(23)
for( _it2018683696 in (studentInstance?.academicyear) ) {
changeItVariable(_it2018683696)
printHtmlPart(20)
if(true && (it.status == 'current')) {
printHtmlPart(20)
}
