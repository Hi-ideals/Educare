...
class gsp_ROOT_listofStudentsgetstlist_gsp extends GroovyPage {
...
printHtmlPart(24)
for( _it1734811057 in (studentInstance?.academicyear) ) {
changeItVariable(_it1734811057)
printHtmlPart(25)
...
printHtmlPart(27)
for( _it1852790850 in (studentInstance?.academicyear) ) {
changeItVariable(_it1852790850)
printHtmlPart(25)
if(true && (it.status == 'current')) {
printHtmlPart(25)
}
