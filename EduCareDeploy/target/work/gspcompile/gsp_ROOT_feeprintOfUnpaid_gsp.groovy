...
class gsp_ROOT_feeprintOfUnpaid_gsp extends GroovyPage {
...
printHtmlPart(11)
for( _it1357442420 in (st?.academicyear) ) {
changeItVariable(_it1357442420)
printHtmlPart(12)
...
printHtmlPart(10)
for( _it1961537655 in (st?.academicyear) ) {
