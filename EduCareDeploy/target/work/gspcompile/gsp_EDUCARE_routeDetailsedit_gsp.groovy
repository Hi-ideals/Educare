...
class gsp_EDUCARE_routeDetailsedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/routeDetails/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',81,['template':("/header/leftSide"),'model':([activ:[TransportManagement:'start active open',RouteDetails:'active']])],-1)
printHtmlPart(8)
...
invokeTag('eachError','g',122,['bean':(routeDetailsInstance),'var':("error")],3)
printHtmlPart(24)
})
invokeTag('hasErrors','g',124,['bean':(routeDetailsInstance)],2)
printHtmlPart(25)
createTagBody(2, {->
printHtmlPart(26)
invokeTag('hiddenField','g',140,['name':("version"),'value':(routeDetailsInstance?.version)],-1)
printHtmlPart(27)
invokeTag('render','g',142,['template':("form")],-1)
printHtmlPart(28)
invokeTag('actionSubmit','g',148,['class':("save  btn blue"),'id':("routeDetails"),'action':("update"),'value':(message(code: 'default.button.update.label', default: 'Update'))],-1)
printHtmlPart(29)
})
invokeTag('form','g',150,['url':([resource:routeDetailsInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(30)
...
public static final long LAST_MODIFIED = 1628926003670L
