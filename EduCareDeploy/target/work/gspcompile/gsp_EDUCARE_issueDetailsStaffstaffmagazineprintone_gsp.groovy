...
class gsp_EDUCARE_issueDetailsStaffstaffmagazineprintone_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/issueDetailsStaff/staffmagazineprintone.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(18)
invokeTag('formatDate','g',161,['date':(c?.issuedate),'type':("date"),'style':("SHORT")],-1)
printHtmlPart(19)
invokeTag('formatDate','g',163,['date':(c?.returndate),'type':("date"),'style':("SHORT")],-1)
printHtmlPart(20)
...
invokeTag('captureBody','sitemesh',262,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(24)
}
...
public static final long LAST_MODIFIED = 1628925995142L
