...
class gsp_EDUCARE_timeTable_formTable_gsp extends GroovyPage {
...
printHtmlPart(7)
for( _it1303293320 in (1..noOfColumnsCount) ) {
changeItVariable(_it1303293320)
printHtmlPart(8)
expressionOut.print(100/(noOfColumnsCount+1))
printHtmlPart(9)
expressionOut.print(null)
printHtmlPart(10)
for( _it70952807 in (PT) ) {
changeItVariable(_it70952807)
printHtmlPart(11)
...
printHtmlPart(17)
for( _it1530663374 in (days) ) {
changeItVariable(_it1530663374)
printHtmlPart(18)
expressionOut.print(100/(noOfColumnsCount+1 ?: 1))
printHtmlPart(19)
expressionOut.print(it)
printHtmlPart(20)
for( _it1180122366 in (1..noOfColumnsCount) ) {
changeItVariable(_it1180122366)
printHtmlPart(21)
expressionOut.print(100/(noOfColumnsCount+1 ?: 1))
printHtmlPart(22)
