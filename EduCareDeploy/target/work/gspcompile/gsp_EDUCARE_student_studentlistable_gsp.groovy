...
class gsp_EDUCARE_student_studentlistable_gsp extends GroovyPage {
...
printHtmlPart(21)
for( _it2114535884 in (studentInstance?.academicyear) ) {
changeItVariable(_it2114535884)
printHtmlPart(22)
...
printHtmlPart(25)
for( _it1360316577 in (studentInstance?.academicyear) ) {
changeItVariable(_it1360316577)
printHtmlPart(22)
if(true && (it.status == 'current')) {
printHtmlPart(22)
}
