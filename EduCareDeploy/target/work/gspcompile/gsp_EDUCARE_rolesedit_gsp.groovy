...
class gsp_EDUCARE_rolesedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/roles/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',66,['template':("/header/leftSide"),'model':([activ:[roles:'start active open']])],-1)
printHtmlPart(8)
...
invokeTag('eachError','g',103,['bean':(rolesInstance),'var':("error")],3)
printHtmlPart(21)
})
invokeTag('hasErrors','g',105,['bean':(rolesInstance)],2)
printHtmlPart(14)
createTagBody(2, {->
printHtmlPart(22)
invokeTag('hiddenField','g',109,['name':("version"),'value':(rolesInstance?.version)],-1)
printHtmlPart(23)
invokeTag('render','g',111,['template':("form")],-1)
printHtmlPart(24)
invokeTag('actionSubmit','g',116,['class':("btn btn-success"),'action':("update"),'value':(message(code: 'default.button.update.label', default: 'Update'))],-1)
printHtmlPart(25)
})
invokeTag('form','g',118,['url':([resource:rolesInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(26)
invokeTag('render','g',132,['template':("/footer/footer")],-1)
printHtmlPart(27)
})
...
public static final long LAST_MODIFIED = 1628925995266L
