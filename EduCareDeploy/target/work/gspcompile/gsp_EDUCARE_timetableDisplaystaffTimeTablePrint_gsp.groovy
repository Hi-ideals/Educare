...
class gsp_EDUCARE_timetableDisplaystaffTimeTablePrint_gsp extends GroovyPage {
...
printHtmlPart(17)
for( _it1910857288 in (1..8) ) {
changeItVariable(_it1910857288)
printHtmlPart(18)
expressionOut.print((100/9))
printHtmlPart(19)
...
printHtmlPart(21)
for( _it912877601 in (weekdaysMap.keySet()) ) {
changeItVariable(_it912877601)
printHtmlPart(22)
expressionOut.print((100/9))
printHtmlPart(23)
...
printHtmlPart(25)
for( _it1593914910 in (1..8) ) {
changeItVariable(_it1593914910)
printHtmlPart(26)
expressionOut.print((100/9))
printHtmlPart(27)
