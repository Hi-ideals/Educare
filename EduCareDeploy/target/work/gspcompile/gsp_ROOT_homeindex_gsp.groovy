...
class gsp_ROOT_homeindex_gsp extends GroovyPage {
...
invokeTag('link','g',100,['controller':("login"),'action':("auth")],2)
printHtmlPart(7)
})
invokeTag('captureBody','sitemesh',565,['class':("page-container-bg-solid page-header-top-fixed page-boxed")],1)
printHtmlPart(8)
}
...
public static final long LAST_MODIFIED = 1650433518000L
