...
class gsp_EDUCARE_payHeadedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/payHead/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',79,['template':("/header/leftSide"),'model':([activ:[payroll:'start active open',payheadcreate:'active']])],-1)
printHtmlPart(8)
...
invokeTag('eachError','g',122,['bean':(subjectInstance),'var':("error")],3)
printHtmlPart(21)
})
invokeTag('hasErrors','g',124,['bean':(subjectInstance)],2)
printHtmlPart(22)
createTagBody(2, {->
printHtmlPart(23)
invokeTag('hiddenField','g',138,['name':("version"),'value':(payHeadInstance?.version)],-1)
printHtmlPart(24)
invokeTag('render','g',140,['template':("form")],-1)
printHtmlPart(25)
invokeTag('actionSubmit','g',144,['class':("save btn blue"),'action':("update"),'id':("payHead"),'value':(message(code: 'default.button.update.label', default: 'Update'))],-1)
printHtmlPart(26)
})
invokeTag('form','g',146,['url':([resource:payHeadInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(27)
...
public static final long LAST_MODIFIED = 1628925998586L
