...
class gsp_ROOT_issueDetailsbookReturnStaff_gsp extends GroovyPage {
...
printHtmlPart(30)
for( _it1627112269 in (staffs) ) {
changeItVariable(_it1627112269)
printHtmlPart(31)
...
printHtmlPart(39)
for( _it2000077854 in (com.hiideals.institute.library.Magazine.list()) ) {
changeItVariable(_it2000077854)
printHtmlPart(40)
expressionOut.print(it.id)
printHtmlPart(41)
...
printHtmlPart(45)
for( _it1603345700 in (com.hiideals.institute.library.Newspaper.list()) ) {
changeItVariable(_it1603345700)
printHtmlPart(40)
expressionOut.print(it.id)
printHtmlPart(41)
