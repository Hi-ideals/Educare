...
class gsp_ROOT_studentreAdmission_gsp extends GroovyPage {
...
printHtmlPart(24)
for( _it135347879 in (studentInstance?.academicyear) ) {
changeItVariable(_it135347879)
printHtmlPart(23)
...
printHtmlPart(31)
for( _it478650119 in (studentInstance?.academicyear) ) {
changeItVariable(_it478650119)
printHtmlPart(25)
if(true && (it.status == 'current')) {
printHtmlPart(25)
}
...
printHtmlPart(39)
for( _it126767009 in (studentInstance?.academicyear) ) {
changeItVariable(_it126767009)
printHtmlPart(25)
if(true && (it.status == 'current')) {
printHtmlPart(25)
}
...
printHtmlPart(73)
for( _it1159119599 in (rut) ) {
changeItVariable(_it1159119599)
printHtmlPart(74)
...
printHtmlPart(80)
for( _it1156790508 in (dst) ) {
changeItVariable(_it1156790508)
printHtmlPart(74)
expressionOut.print(it?.id)
printHtmlPart(75)
