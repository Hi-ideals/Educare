...
class gsp_ROOT_student_rejoinList_gsp extends GroovyPage {
...
printHtmlPart(12)
for( _it688425953 in (studentInstance?.academicyear) ) {
changeItVariable(_it688425953)
printHtmlPart(13)
...
printHtmlPart(16)
for( _it470399866 in (studentInstance?.academicyear) ) {
changeItVariable(_it470399866)
printHtmlPart(13)
