...
class gsp_ROOT_studentList_feeDisplay_gsp extends GroovyPage {
...
printHtmlPart(3)
for( _it1543351283 in (student?.academicyear) ) {
changeItVariable(_it1543351283)
printHtmlPart(4)
...
printHtmlPart(8)
for( _it1074601008 in (student?.academicyear) ) {
changeItVariable(_it1074601008)
printHtmlPart(4)
if(true && (it.status == 'current')) {
printHtmlPart(4)
}
