...
class gsp_EDUCARE_newspaperprintNewspaperList_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/newspaper/printNewspaperList.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('getImage','images',107,['id':(instituite?.logo?.id),'width':("100px")],-1)
printHtmlPart(8)
...
printHtmlPart(18)
invokeTag('formatDate','g',156,['date':(newspaperInstance.dateofnewspaper),'type':("date"),'style':("SHORT")],-1)
printHtmlPart(19)
...
invokeTag('captureBody','sitemesh',258,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(23)
}
...
public static final long LAST_MODIFIED = 1628925993956L
