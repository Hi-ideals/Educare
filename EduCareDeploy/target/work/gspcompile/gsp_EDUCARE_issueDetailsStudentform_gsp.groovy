...
class gsp_EDUCARE_issueDetailsStudentform_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/issueDetailsStudent/form.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(6)
invokeTag('render','g',67,['template':("/header/leftSide"),'model':([activ:[BooksReport:'start active open',issueDetailsStudentManagine:'active']])],-1)
printHtmlPart(7)
...
invokeTag('form','g',92,['controller':("issueDetailsStudent"),'action':("report")],2)
printHtmlPart(11)
createClosureForHtmlPart(12, 2)
invokeTag('form','g',104,['controller':("issueDetailsStudent"),'action':("studentmagazinereport")],2)
printHtmlPart(13)
invokeTag('render','g',105,['template':("/footer/footer")],-1)
printHtmlPart(14)
})
...
public static final long LAST_MODIFIED = 1628926004856L
