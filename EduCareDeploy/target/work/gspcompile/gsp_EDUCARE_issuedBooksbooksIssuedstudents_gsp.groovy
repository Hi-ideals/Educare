...
class gsp_EDUCARE_issuedBooksbooksIssuedstudents_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/issuedBooks/booksIssuedstudents.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('getImage','images',101,['id':(instituite?.logo?.id),'width':("100px")],-1)
printHtmlPart(8)
...
printHtmlPart(15)
for( _it839213325 in (issuedToStudents) ) {
changeItVariable(_it839213325)
printHtmlPart(16)
expressionOut.print(it.books.accessionNumber.toString().replace('[', '').replace(']', ''))
printHtmlPart(17)
expressionOut.print(it.studentId.studentId)
printHtmlPart(17)
expressionOut.print(it.studentId.presentclass)
printHtmlPart(17)
expressionOut.print(it.studentId.studentName)
printHtmlPart(17)
expressionOut.print(it.books.title.toString().replace('[', '').replace(']', ''))
printHtmlPart(18)
invokeTag('formatDate','g',163,['format':("dd-MMM-yyyy"),'date':(it.dateOfIssue)],-1)
printHtmlPart(19)
invokeTag('formatDate','g',165,['format':("dd-MMM-yyyy"),'date':(it.dateOfReturn)],-1)
printHtmlPart(20)
}
printHtmlPart(21)
...
public static final long LAST_MODIFIED = 1628925993152L
