...
class gsp_EDUCARE_issueDetailsStaffmagazinereport_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/issueDetailsStaff/magazinereport.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(8)
invokeTag('render','g',80,['template':("/header/leftSide"),'model':([activ:[BooksReport:'start active open',issueDetailsStaffManagine:'active']])],-1)
printHtmlPart(9)
...
printHtmlPart(14)
invokeTag('formatDate','g',135,['date':(c?.issuedate),'format':("dd-MMM-yyyy"),'style':("SHORT")],-1)
printHtmlPart(15)
invokeTag('formatDate','g',137,['date':(c?.returndate),'format':("dd-MMM-yyyy"),'style':("SHORT")],-1)
printHtmlPart(15)
createTagBody(3, {->
printHtmlPart(16)
...
invokeTag('form','g',144,['controller':("IssueDetailsStaff"),'action':("returned")],3)
printHtmlPart(19)
j++
}
}
...
public static final long LAST_MODIFIED = 1628925995176L
