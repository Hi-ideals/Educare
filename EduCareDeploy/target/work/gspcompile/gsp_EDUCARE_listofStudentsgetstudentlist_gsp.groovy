...
class gsp_EDUCARE_listofStudentsgetstudentlist_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/listofStudents/getstudentlist.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(21)
invokeTag('message','g',155,['code':("student.guardianDetails.label"),'default':("Student Name")],-1)
printHtmlPart(22)
invokeTag('message','g',160,['code':("student.guardianDetails.label"),'default':("Class ")],-1)
printHtmlPart(23)
loop:{
int i = 0
...
printHtmlPart(31)
for( _it628845656 in (studentInstance?.academicyear) ) {
changeItVariable(_it628845656)
printHtmlPart(32)
...
printHtmlPart(11)
invokeTag('set','g',190,['value':(it?.presentclass),'var':("pclass")],-1)
printHtmlPart(33)
expressionOut.print(pclass.classname)
printHtmlPart(34)
for( _it1793273840 in (studentInstance?.academicyear) ) {
changeItVariable(_it1793273840)
printHtmlPart(32)
if(true && (it.status == 'current')) {
printHtmlPart(32)
}
...
printHtmlPart(11)
invokeTag('set','g',195,['value':(it?.section),'var':("pclass")],-1)
printHtmlPart(33)
expressionOut.print(pclass.sectionName)
printHtmlPart(35)
invokeTag('formatDate','g',199,['format':("dd-MMM-yyyy"),'date':(studentInstance.studentDOJ)],-1)
printHtmlPart(36)
i++
}
}
printHtmlPart(37)
invokeTag('render','g',244,['template':("/footer/footer")],-1)
printHtmlPart(38)
})
...
public static final long LAST_MODIFIED = 1628926011043L
