...
class gsp_EDUCARE_feeindividualstfee_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/fee/individualstfee.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',79,['template':("/header/leftSide"),'model':([activ:[feeStructure:'start active open',fee1:'active']])],-1)
printHtmlPart(8)
...
printHtmlPart(17)
invokeTag('render','g',148,['template':("sectionlist"),'model':([classId:classId])],-1)
printHtmlPart(18)
...
printHtmlPart(19)
invokeTag('submitButton','g',169,['name':("Search"),'class':("btn blue"),'id':("Collectstudentfee"),'style':("margin-top: 22px")],-1)
printHtmlPart(20)
})
invokeTag('formRemote','g',172,['name':("formremote"),'url':([action:'getIndividualstudentFees']),'update':("Changedisplay")],2)
printHtmlPart(21)
invokeTag('render','g',196,['template':("/footer/footer")],-1)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1628926001671L
