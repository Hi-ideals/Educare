...
class gsp_EDUCARE_returnBookbookReturn_gsp extends GroovyPage {
...
printHtmlPart(24)
for( _it148823752 in (Student.list()) ) {
changeItVariable(_it148823752)
printHtmlPart(25)
...
expressionOut.print(null)
printHtmlPart(24)
for( _it577672681 in (com.hiideals.institute.staff.Staff.list()) ) {
changeItVariable(_it577672681)
printHtmlPart(25)
expressionOut.print(it.id)
printHtmlPart(26)
...
printHtmlPart(36)
for( _it666851147 in (com.hiideals.institute.library.Magazine.list()) ) {
changeItVariable(_it666851147)
printHtmlPart(25)
expressionOut.print(it.id)
printHtmlPart(26)
...
printHtmlPart(38)
for( _it1287328228 in (com.hiideals.institute.library.Newspaper.list()) ) {
changeItVariable(_it1287328228)
printHtmlPart(25)
expressionOut.print(it.id)
printHtmlPart(26)
