...
class gsp_ROOT_studentshow_gsp extends GroovyPage {
...
printHtmlPart(18)
for( _it279697743 in (studentInstance?.academicyear) ) {
changeItVariable(_it279697743)
printHtmlPart(19)
...
printHtmlPart(36)
for( _it1203756577 in (studentInstance?.academicyear) ) {
changeItVariable(_it1203756577)
printHtmlPart(37)
if(true && (it.status == 'current')) {
printHtmlPart(37)
}
...
expressionOut.print(pclass.classname)
printHtmlPart(41)
for( _it1653541174 in (studentInstance?.academicyear) ) {
changeItVariable(_it1653541174)
printHtmlPart(37)
if(true && (it.status == 'current')) {
printHtmlPart(37)
}
...
expressionOut.print(studentInstance?.studentId)
printHtmlPart(86)
for( _it544239216 in (studentInstance?.academicyear) ) {
changeItVariable(_it544239216)
printHtmlPart(87)
if(true && (it.status == 'current')) {
printHtmlPart(87)
}
