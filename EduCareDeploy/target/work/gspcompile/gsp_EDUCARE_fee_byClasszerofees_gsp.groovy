...
class gsp_EDUCARE_fee_byClasszerofees_gsp extends GroovyPage {
...
printHtmlPart(4)
for( _it262217690 in (st?.academicyear) ) {
changeItVariable(_it262217690)
printHtmlPart(5)
...
printHtmlPart(4)
for( _it618785034 in (st?.academicyear) ) {
changeItVariable(_it618785034)
printHtmlPart(5)
if(true && (it.status == 'current')) {
printHtmlPart(5)
}
