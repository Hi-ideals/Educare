...
class gsp_ROOT_timetableDisplay_shTT_gsp extends GroovyPage {
...
printHtmlPart(1)
for( _it767760847 in (1..8) ) {
changeItVariable(_it767760847)
printHtmlPart(2)
expressionOut.print((100/9))
printHtmlPart(3)
...
printHtmlPart(5)
for( _it23660841 in (weekdaysMap.keySet()) ) {
changeItVariable(_it23660841)
printHtmlPart(6)
expressionOut.print((100/9))
printHtmlPart(7)
...
printHtmlPart(9)
for( _it886205032 in (1..8) ) {
changeItVariable(_it886205032)
printHtmlPart(10)
expressionOut.print((100/9))
printHtmlPart(11)
