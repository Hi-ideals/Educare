...
class gsp_ROOT_feenewFeeupdate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/fee/newFeeupdate.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(4)
invokeTag('getImage','images',23,['id':(institute?.logo?.id),'width':("60px"),'height':("60px")],-1)
printHtmlPart(5)
...
printHtmlPart(9)
expressionOut.print(fInstance.dueT)
printHtmlPart(9)
...
public static final long LAST_MODIFIED = 1628926001651L
