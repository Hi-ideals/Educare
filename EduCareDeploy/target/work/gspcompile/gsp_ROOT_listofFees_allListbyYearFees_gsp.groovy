...
class gsp_ROOT_listofFees_allListbyYearFees_gsp extends GroovyPage {
...
printHtmlPart(13)
for( _it1373527802 in (studentInstance?.studentId?.academicyear) ) {
changeItVariable(_it1373527802)
printHtmlPart(14)
