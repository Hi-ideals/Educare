...
class gsp_ROOT_studentpopfeeprint_gsp extends GroovyPage {
...
printHtmlPart(18)
for( _it1209802386 in (studentInstance?.academicyear) ) {
changeItVariable(_it1209802386)
printHtmlPart(9)
...
printHtmlPart(21)
for( _it1727144954 in (studentInstance?.academicyear) ) {
changeItVariable(_it1727144954)
printHtmlPart(9)
if(true && (it.status == 'current')) {
printHtmlPart(9)
}
...
printHtmlPart(28)
for( _it2059697940 in (studentInstance?.academicyear) ) {
changeItVariable(_it2059697940)
printHtmlPart(9)
if(true && (it.status == 'current')) {
printHtmlPart(9)
}
