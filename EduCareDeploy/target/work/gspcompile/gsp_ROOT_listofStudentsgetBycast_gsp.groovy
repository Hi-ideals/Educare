...
class gsp_ROOT_listofStudentsgetBycast_gsp extends GroovyPage {
...
printHtmlPart(32)
for( _it1741522169 in (studentInstance?.academicyear) ) {
changeItVariable(_it1741522169)
printHtmlPart(33)
...
printHtmlPart(35)
for( _it1387827678 in (studentInstance?.academicyear) ) {
changeItVariable(_it1387827678)
printHtmlPart(33)
if(true && (it.status == 'current')) {
printHtmlPart(33)
}
