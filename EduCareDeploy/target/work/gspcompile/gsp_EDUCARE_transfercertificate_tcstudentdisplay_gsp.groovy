...
class gsp_EDUCARE_transfercertificate_tcstudentdisplay_gsp extends GroovyPage {
...
printHtmlPart(13)
for( _it1679027895 in (student?.academicyear) ) {
changeItVariable(_it1679027895)
printHtmlPart(0)
...
printHtmlPart(15)
for( _it156684093 in (student?.academicyear) ) {
changeItVariable(_it156684093)
printHtmlPart(0)
if(true && (it.status == 'current')) {
printHtmlPart(0)
}
