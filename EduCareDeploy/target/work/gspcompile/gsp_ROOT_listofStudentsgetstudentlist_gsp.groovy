...
class gsp_ROOT_listofStudentsgetstudentlist_gsp extends GroovyPage {
...
printHtmlPart(31)
for( _it1375340999 in (studentInstance?.academicyear) ) {
changeItVariable(_it1375340999)
printHtmlPart(32)
...
printHtmlPart(34)
for( _it1943764464 in (studentInstance?.academicyear) ) {
