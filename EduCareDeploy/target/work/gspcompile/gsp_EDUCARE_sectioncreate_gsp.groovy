...
class gsp_EDUCARE_sectioncreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/section/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',75,['template':("/header/leftSide"),'model':([activ:[Settings:'start active open',section:'active']])],-1)
printHtmlPart(8)
...
invokeTag('eachError','g',113,['bean':(sectionInstance),'var':("error")],3)
printHtmlPart(21)
})
invokeTag('hasErrors','g',115,['bean':(sectionInstance)],2)
printHtmlPart(22)
createTagBody(2, {->
printHtmlPart(23)
...
printHtmlPart(25)
invokeTag('username','sec',134,[:],-1)
printHtmlPart(26)
invokeTag('submitButton','g',139,['name':("create"),'class':("btn blue"),'disabled':("true"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(27)
}
else {
printHtmlPart(28)
invokeTag('submitButton','g',145,['name':("create"),'class':("btn blue"),'id':("Createsecation"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(29)
}
printHtmlPart(30)
})
invokeTag('form','g',148,['url':([resource:sectionInstance, action:'save'])],2)
printHtmlPart(31)
...
public static final long LAST_MODIFIED = 1628926014141L
