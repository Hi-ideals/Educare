...
class gsp_EDUCARE_listofFeesindividualstudentFees_gsp extends GroovyPage {
...
printHtmlPart(18)
for( _it900416096 in (arryl[i]?.academicyear) ) {
changeItVariable(_it900416096)
printHtmlPart(19)
...
printHtmlPart(22)
for( _it1980976027 in (arryl[i]?.academicyear) ) {
changeItVariable(_it1980976027)
printHtmlPart(19)
if(true && (it.status == 'current')) {
printHtmlPart(19)
}
