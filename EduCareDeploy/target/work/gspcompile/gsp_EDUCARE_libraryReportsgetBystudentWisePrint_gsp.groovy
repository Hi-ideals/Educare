...
class gsp_EDUCARE_libraryReportsgetBystudentWisePrint_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/libraryReports/getBystudentWisePrint.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(21)
invokeTag('render','g',222,['template':("/footer/footer")],-1)
printHtmlPart(22)
})
invokeTag('captureBody','sitemesh',260,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(23)
}
...
public static final long LAST_MODIFIED = 1628925999752L
