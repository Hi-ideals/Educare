...
class gsp_ROOT_studentfeedetailprint_gsp extends GroovyPage {
...
printHtmlPart(18)
for( _it2083660714 in (studentInstance?.academicyear) ) {
changeItVariable(_it2083660714)
printHtmlPart(9)
...
printHtmlPart(21)
for( _it1988351538 in (studentInstance?.academicyear) ) {
changeItVariable(_it1988351538)
printHtmlPart(9)
if(true && (it.status == 'current')) {
printHtmlPart(9)
}
...
printHtmlPart(28)
for( _it1362881676 in (studentInstance?.academicyear) ) {
changeItVariable(_it1362881676)
printHtmlPart(9)
if(true && (it.status == 'current')) {
printHtmlPart(9)
}
