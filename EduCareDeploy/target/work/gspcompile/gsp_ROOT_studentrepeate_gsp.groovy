...
class gsp_ROOT_studentrepeate_gsp extends GroovyPage {
...
printHtmlPart(24)
for( _it1111811191 in (studentInstance?.academicyear) ) {
changeItVariable(_it1111811191)
printHtmlPart(23)
...
printHtmlPart(31)
for( _it150499707 in (studentInstance?.academicyear) ) {
changeItVariable(_it150499707)
printHtmlPart(25)
if(true && (it.status == 'current')) {
printHtmlPart(25)
}
...
printHtmlPart(35)
for( _it1667321053 in (studentInstance?.academicyear) ) {
changeItVariable(_it1667321053)
printHtmlPart(25)
if(true && (it.status == 'current')) {
printHtmlPart(25)
}
...
printHtmlPart(69)
for( _it513755348 in (rut) ) {
changeItVariable(_it513755348)
printHtmlPart(70)
...
printHtmlPart(76)
for( _it2073911340 in (dst) ) {
changeItVariable(_it2073911340)
printHtmlPart(70)
expressionOut.print(it?.id)
printHtmlPart(71)
