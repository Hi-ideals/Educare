...
class gsp_EDUCARE_instituitecreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/instituite/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',112,['bean':(instituiteInstance),'var':("error")],3)
printHtmlPart(21)
})
invokeTag('hasErrors','g',114,['bean':(instituiteInstance)],2)
printHtmlPart(22)
createTagBody(2, {->
printHtmlPart(23)
invokeTag('render','g',129,['template':("form")],-1)
printHtmlPart(24)
invokeTag('submitButton','g',134,['name':("create"),'class':("btn blue"),'id':("instituitecreate"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(25)
})
invokeTag('form','g',136,['url':([resource:instituiteInstance, action:'save']),'enctype':("multipart/form-data")],2)
printHtmlPart(26)
...
public static final long LAST_MODIFIED = 1628925998343L
