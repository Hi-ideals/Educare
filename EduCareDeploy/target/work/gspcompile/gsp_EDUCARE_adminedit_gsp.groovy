...
class gsp_EDUCARE_adminedit_gsp extends GroovyPage {
...
invokeTag('hasErrors','g',91,['bean':(adminInstance)],2)
printHtmlPart(22)
createTagBody(2, {->
printHtmlPart(23)
invokeTag('hiddenField','g',108,['name':("version"),'value':(adminInstance?.version)],-1)
printHtmlPart(24)
invokeTag('render','g',110,['template':("form"),'model':([edit:'none'])],-1)
printHtmlPart(25)
invokeTag('actionSubmit','g',115,['class':("btn blue"),'action':("update"),'value':(message(code: 'default.button.update.label', default: 'Update'))],-1)
printHtmlPart(26)
})
invokeTag('form','g',115,['url':([resource:adminInstance, action:'update']),'enctype':("multipart/form-data")],2)
printHtmlPart(27)
invokeTag('render','g',123,['template':("/footer/footer")],-1)
printHtmlPart(28)
})
invokeTag('captureBody','sitemesh',153,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(29)
}
...
public static final long LAST_MODIFIED = 1628925996309L
