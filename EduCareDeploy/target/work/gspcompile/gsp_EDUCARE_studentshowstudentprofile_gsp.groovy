...
class gsp_EDUCARE_studentshowstudentprofile_gsp extends GroovyPage {
...
printHtmlPart(22)
for( _it1000630341 in (studentInstance?.academicyear) ) {
changeItVariable(_it1000630341)
printHtmlPart(23)
...
printHtmlPart(25)
for( _it1084394458 in (studentInstance?.academicyear) ) {
changeItVariable(_it1084394458)
printHtmlPart(23)
if(true && (it.status == 'current')) {
printHtmlPart(23)
}
