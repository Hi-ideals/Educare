...
class gsp_EDUCARE_studentspecificviewfeedetail_gsp extends GroovyPage {
...
printHtmlPart(16)
for( _it1112551577 in (stdetails?.academicyear) ) {
changeItVariable(_it1112551577)
printHtmlPart(17)
...
printHtmlPart(19)
for( _it970827119 in (studentInstance?.academicyear) ) {
changeItVariable(_it970827119)
printHtmlPart(17)
if(true && (it.status == 'current')) {
printHtmlPart(17)
}
...
printHtmlPart(21)
for( _it1619282322 in (stdetails?.academicyear) ) {
changeItVariable(_it1619282322)
printHtmlPart(17)
if(true && (it.status == 'current')) {
printHtmlPart(17)
}
