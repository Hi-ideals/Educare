...
class gsp_EDUCARE_destinationDetailscreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/destinationDetails/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',79,['template':("/header/leftSide"),'model':([activ:[TransportManagement:'start active open',DestinationDetails:'active']])],-1)
printHtmlPart(8)
...
invokeTag('eachError','g',110,['bean':(destinationDetailsInstance),'var':("error")],3)
printHtmlPart(22)
})
invokeTag('hasErrors','g',112,['bean':(destinationDetailsInstance)],2)
printHtmlPart(23)
createTagBody(2, {->
printHtmlPart(24)
invokeTag('render','g',127,['template':("form")],-1)
printHtmlPart(25)
invokeTag('submitButton','g',133,['name':("create"),'class':("save btn blue"),'id':("destinationDetails"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(26)
})
invokeTag('form','g',135,['url':([resource:destinationDetailsInstance, action:'save'])],2)
printHtmlPart(27)
invokeTag('render','g',143,['template':("/footer/footer")],-1)
printHtmlPart(28)
})
...
public static final long LAST_MODIFIED = 1628925992763L
