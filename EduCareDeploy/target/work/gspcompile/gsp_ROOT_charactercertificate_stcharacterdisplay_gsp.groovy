...
class gsp_ROOT_charactercertificate_stcharacterdisplay_gsp extends GroovyPage {
...
printHtmlPart(5)
for( _it1227653431 in (student?.academicyear) ) {
changeItVariable(_it1227653431)
printHtmlPart(6)
...
printHtmlPart(9)
for( _it1108039149 in (student?.academicyear) ) {
changeItVariable(_it1108039149)
printHtmlPart(6)
if(true && (it.status == 'current')) {
printHtmlPart(6)
}
