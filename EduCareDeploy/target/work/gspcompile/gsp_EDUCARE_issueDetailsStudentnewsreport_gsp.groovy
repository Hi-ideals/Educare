...
class gsp_EDUCARE_issueDetailsStudentnewsreport_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/issueDetailsStudent/newsreport.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',148,['controller':("IssueDetailsStudent"),'action':("returned1")],3)
printHtmlPart(21)
j++
}
}
...
public static final long LAST_MODIFIED = 1628926004785L
