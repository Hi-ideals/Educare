...
class gsp_EDUCARE_issueDetailsStaffstaffmagazineprint_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/issueDetailsStaff/staffmagazineprint.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('getImage','images',104,['id':(instituite?.logo?.id),'width':("100px")],-1)
printHtmlPart(8)
...
printHtmlPart(18)
invokeTag('formatDate','g',158,['date':(c?.issuedate),'type':("date"),'style':("SHORT")],-1)
printHtmlPart(19)
invokeTag('formatDate','g',160,['date':(c?.returndate),'type':("date"),'style':("SHORT")],-1)
printHtmlPart(20)
...
printHtmlPart(22)
invokeTag('render','g',212,['template':("/footer/footer")],-1)
printHtmlPart(23)
})
...
public static final long LAST_MODIFIED = 1628925995138L
