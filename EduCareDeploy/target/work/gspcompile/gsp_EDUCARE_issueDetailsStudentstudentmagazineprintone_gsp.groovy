...
class gsp_EDUCARE_issueDetailsStudentstudentmagazineprintone_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/issueDetailsStudent/studentmagazineprintone.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('getImage','images',104,['id':(instituite?.logo?.id),'width':("160px")],-1)
printHtmlPart(8)
...
printHtmlPart(18)
invokeTag('formatDate','g',157,['date':(c?.issuedate),'type':("date"),'style':("SHORT")],-1)
printHtmlPart(19)
invokeTag('formatDate','g',159,['date':(c?.returndate),'type':("date"),'style':("SHORT")],-1)
printHtmlPart(20)
...
public static final long LAST_MODIFIED = 1628926004838L
