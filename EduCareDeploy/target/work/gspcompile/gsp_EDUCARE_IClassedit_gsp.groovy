...
class gsp_EDUCARE_IClassedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/IClass/edit.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',94,['action':("create")],2)
printHtmlPart(13)
...
createTagBody(2, {->
printHtmlPart(25)
invokeTag('hiddenField','g',132,['name':("version"),'value':(IClassInstance?.version)],-1)
printHtmlPart(26)
invokeTag('render','g',134,['template':("form")],-1)
printHtmlPart(27)
invokeTag('actionSubmit','g',139,['class':("btn blue"),'action':("update"),'id':("createclass"),'value':(message(code: 'default.button.update.label', default: 'Update'))],-1)
printHtmlPart(28)
})
invokeTag('form','g',141,['url':([resource:IClassInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(29)
...
public static final long LAST_MODIFIED = 1628926006063L
