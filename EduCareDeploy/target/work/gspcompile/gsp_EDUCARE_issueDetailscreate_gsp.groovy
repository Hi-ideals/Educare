...
class gsp_EDUCARE_issueDetailscreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/issueDetails/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',75,['template':("/header/leftSide"),'model':([activ:[LibraryManagement:'start active open',issueDetails:'active']])],-1)
printHtmlPart(8)
...
printHtmlPart(25)
invokeTag('submitButton','g',133,['name':("create"),'class':("btn blue"),'id':("student1"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(26)
})
invokeTag('form','g',135,['url':([resource:issueDetailsInstance, action:'save'])],2)
printHtmlPart(27)
invokeTag('render','g',147,['template':("/footer/footer")],-1)
printHtmlPart(28)
})
invokeTag('captureBody','sitemesh',362,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(29)
}
...
public static final long LAST_MODIFIED = 1628925997755L
