...
class gsp_EDUCARE_studentpopfeeprint_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/student/popfeeprint.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(18)
for( _it224447405 in (studentInstance?.academicyear) ) {
changeItVariable(_it224447405)
printHtmlPart(9)
...
printHtmlPart(21)
for( _it1373194140 in (studentInstance?.academicyear) ) {
changeItVariable(_it1373194140)
printHtmlPart(9)
if(true && (it.status == 'current')) {
printHtmlPart(9)
}
...
printHtmlPart(28)
for( _it1965129924 in (studentInstance?.academicyear) ) {
changeItVariable(_it1965129924)
printHtmlPart(9)
if(true && (it.status == 'current')) {
printHtmlPart(9)
}
...
public static final long LAST_MODIFIED = 1628926000541L
