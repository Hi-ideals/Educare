...
class gsp_EDUCARE_charactercertificateprintcharactercrt_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/charactercertificate/printcharactercrt.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('getImage','images',109,['id':(instituite?.logo?.id),'width':("100px")],-1)
printHtmlPart(8)
expressionOut.print(instituite?.name)
printHtmlPart(9)
expressionOut.print(instituite?.affiliatedTo)
printHtmlPart(10)
expressionOut.print(characterInstance.id)
printHtmlPart(11)
expressionOut.print(characterInstance?.regNo)
printHtmlPart(12)
expressionOut.print(characterInstance?.stname)
printHtmlPart(13)
expressionOut.print(characterInstance?.ftname)
printHtmlPart(14)
expressionOut.print(instituite?.name)
printHtmlPart(15)
expressionOut.print(characterInstance.batchno)
printHtmlPart(16)
expressionOut.print(characterInstance.stclass)
printHtmlPart(17)
expressionOut.print(characterInstance?.stcharacter)
printHtmlPart(18)
expressionOut.print(instituite?.name)
printHtmlPart(19)
expressionOut.print(characterInstance.batchno)
printHtmlPart(20)
expressionOut.print(characterInstance?.crtdate)
printHtmlPart(21)
createClosureForHtmlPart(22, 2)
invokeTag('link','g',192,['class':("btn blue"),'controller':("charactercertificate"),'action':("index")],2)
printHtmlPart(23)
...
public static final long LAST_MODIFIED = 1628925998104L
