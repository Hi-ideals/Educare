...
class gsp_EDUCARE_admissionfeecreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/admissionfee/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',59,['template':("/header/leftSide"),'model':([activ:[feeStructure:'start active open',admissionfeecreate:'active']])],-1)
printHtmlPart(8)
...
printHtmlPart(24)
invokeTag('submitButton','g',115,['name':("create"),'class':("btn blue"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(25)
})
invokeTag('form','g',117,['url':([resource:admissionfeeInstance, action:'save']),'enctype':("multipart/form-data")],2)
printHtmlPart(26)
invokeTag('render','g',131,['template':("/footer/footer")],-1)
printHtmlPart(27)
})
invokeTag('captureBody','sitemesh',158,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(28)
}
...
public static final long LAST_MODIFIED = 1628926014561L
