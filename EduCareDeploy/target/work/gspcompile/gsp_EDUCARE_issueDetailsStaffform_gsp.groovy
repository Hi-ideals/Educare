...
class gsp_EDUCARE_issueDetailsStaffform_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/issueDetailsStaff/form.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(6)
invokeTag('render','g',62,['template':("/header/leftSide"),'model':([activ:[BooksReport:'start active open',issueDetailsStaffManagine:'active']])],-1)
printHtmlPart(7)
...
invokeTag('form','g',89,['controller':("issueDetailsStaff"),'action':("magazinereport")],2)
printHtmlPart(11)
createClosureForHtmlPart(12, 2)
invokeTag('form','g',100,['controller':("issueDetailsStaff"),'action':("staffmagazinerep")],2)
printHtmlPart(13)
invokeTag('render','g',101,['template':("/footer/footer")],-1)
printHtmlPart(14)
})
invokeTag('captureBody','sitemesh',136,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(15)
}
...
public static final long LAST_MODIFIED = 1628925995157L
