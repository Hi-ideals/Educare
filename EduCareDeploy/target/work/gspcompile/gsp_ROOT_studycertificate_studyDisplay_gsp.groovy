...
class gsp_ROOT_studycertificate_studyDisplay_gsp extends GroovyPage {
...
printHtmlPart(5)
for( _it1645181497 in (student?.academicyear) ) {
changeItVariable(_it1645181497)
printHtmlPart(6)
...
printHtmlPart(9)
for( _it240653058 in (student?.academicyear) ) {
changeItVariable(_it240653058)
printHtmlPart(6)
if(true && (it.status == 'current')) {
printHtmlPart(6)
}
