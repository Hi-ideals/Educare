...
class gsp_EDUCARE_studentProfileindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/studentProfile/index.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(5)
invokeTag('render','g',44,['template':("/header/logo")],-1)
printHtmlPart(6)
invokeTag('render','g',47,['template':("/header/topBar")],-1)
printHtmlPart(7)
invokeTag('render','g',57,['template':("/header/leftSide")],-1)
printHtmlPart(8)
invokeTag('render','g',458,['template':("/footer/footer")],-1)
printHtmlPart(9)
})
invokeTag('captureBody','sitemesh',484,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(10)
}
...
public static final long LAST_MODIFIED = 1628926004995L
