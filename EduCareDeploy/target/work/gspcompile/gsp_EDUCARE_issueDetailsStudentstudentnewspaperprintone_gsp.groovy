...
class gsp_EDUCARE_issueDetailsStudentstudentnewspaperprintone_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/issueDetailsStudent/studentnewspaperprintone.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(22)
invokeTag('render','g',216,['template':("/footer/footer")],-1)
printHtmlPart(23)
})
...
public static final long LAST_MODIFIED = 1628926004798L
