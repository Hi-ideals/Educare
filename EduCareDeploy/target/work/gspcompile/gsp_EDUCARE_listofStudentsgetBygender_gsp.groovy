...
class gsp_EDUCARE_listofStudentsgetBygender_gsp extends GroovyPage {
...
printHtmlPart(31)
for( _it1062913415 in (studentInstance?.academicyear) ) {
changeItVariable(_it1062913415)
printHtmlPart(32)
...
printHtmlPart(34)
for( _it530942536 in (studentInstance?.academicyear) ) {
