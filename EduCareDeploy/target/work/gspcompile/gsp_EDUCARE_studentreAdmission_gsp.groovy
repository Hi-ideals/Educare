...
class gsp_EDUCARE_studentreAdmission_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/student/reAdmission.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(24)
for( _it617650120 in (studentInstance?.academicyear) ) {
changeItVariable(_it617650120)
printHtmlPart(23)
...
printHtmlPart(31)
for( _it795464262 in (studentInstance?.academicyear) ) {
changeItVariable(_it795464262)
printHtmlPart(25)
if(true && (it.status == 'current')) {
printHtmlPart(25)
}
...
printHtmlPart(39)
for( _it1543358763 in (studentInstance?.academicyear) ) {
changeItVariable(_it1543358763)
printHtmlPart(25)
if(true && (it.status == 'current')) {
printHtmlPart(25)
}
...
printHtmlPart(73)
for( _it1759260499 in (rut) ) {
changeItVariable(_it1759260499)
printHtmlPart(74)
...
printHtmlPart(80)
for( _it1217563479 in (dst) ) {
changeItVariable(_it1217563479)
printHtmlPart(74)
expressionOut.print(it?.id)
printHtmlPart(75)
...
public static final long LAST_MODIFIED = 1628926000337L
