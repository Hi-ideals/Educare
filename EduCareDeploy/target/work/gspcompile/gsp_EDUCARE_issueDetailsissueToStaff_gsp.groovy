...
class gsp_EDUCARE_issueDetailsissueToStaff_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/issueDetails/issueToStaff.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',96,['class':("list"),'action':("staffDetails")],2)
printHtmlPart(12)
...
printHtmlPart(20)
invokeTag('message','g',112,['error':(error)],-1)
printHtmlPart(21)
})
invokeTag('eachError','g',113,['bean':(issueDetailsInstance),'var':("error")],3)
printHtmlPart(22)
})
invokeTag('hasErrors','g',115,['bean':(issueDetailsInstance)],2)
printHtmlPart(23)
createTagBody(2, {->
printHtmlPart(24)
invokeTag('getInstituite','regId',127,[:],-1)
printHtmlPart(25)
expressionOut.print(hasErrors(bean: issueDetailsInstance, field: 'studentId', 'error'))
printHtmlPart(26)
invokeTag('message','g',137,['code':("issueDetails.studentId.label"),'default':("Select issueDetails")],-1)
printHtmlPart(27)
expressionOut.print(hasErrors(bean: issueDetailsInstance, field: 'studentId', 'error'))
printHtmlPart(28)
invokeTag('message','g',161,['code':("issueDetails.studentId.label"),'default':("Student Name")],-1)
printHtmlPart(29)
...
printHtmlPart(37)
invokeTag('message','g',189,['code':("issueDetails.staffId.label"),'default':("Staff Name")],-1)
printHtmlPart(38)
...
expressionOut.print(hasErrors(bean: issueDetailsInstance, field: 'studentId', 'error'))
printHtmlPart(26)
invokeTag('message','g',216,['code':("issueDetails.studentId.label"),'default':("Select category")],-1)
printHtmlPart(41)
expressionOut.print(null)
printHtmlPart(42)
expressionOut.print(hasErrors(bean: issueDetailsInstance, field: 'magazineId', 'error'))
printHtmlPart(43)
invokeTag('message','g',241,['code':("issueDetails.magazineId.label"),'default':("Magazine name")],-1)
printHtmlPart(44)
...
printHtmlPart(50)
invokeTag('message','g',267,['code':("issueDetails.booksId.label"),'default':("Books name")],-1)
printHtmlPart(51)
...
printHtmlPart(53)
invokeTag('message','g',296,['code':("issueDetails.newspaper.label"),'default':("Newspaper name")],-1)
printHtmlPart(54)
...
printHtmlPart(57)
invokeTag('message','g',330,['code':("issueDetails.dateOfIssue.label"),'default':("dateOfIssue")],-1)
printHtmlPart(58)
invokeTag('datePicker','g',333,['name':("dateOfIssue"),'precision':("day"),'value':(new Date())],-1)
printHtmlPart(59)
expressionOut.print(hasErrors(bean: issueDetailsInstance, field: 'numberOfDays', 'error'))
printHtmlPart(60)
invokeTag('message','g',338,['code':("issueDetails.numberOfDays.label"),'default':("Number Of Days")],-1)
printHtmlPart(61)
invokeTag('field','g',344,['name':("numberOfDays"),'class':("form-control"),'type':("number"),'id':("numberOfDays"),'value':(issueDetailsInstance?.numberOfDays),'required':("")],-1)
printHtmlPart(62)
invokeTag('message','g',353,['code':("issueDetails.instituite.label"),'default':("Instituite")],-1)
printHtmlPart(63)
expressionOut.print(hasErrors(bean: issueDetailsInstance, field: 'instituite', 'error'))
printHtmlPart(64)
invokeTag('textField','g',372,['name':("instituite"),'required':(""),'class':("form-control"),'type':("hidden"),'value':(instituite?.id)],-1)
printHtmlPart(65)
invokeTag('submitButton','g',378,['name':("create"),'class':("btn blue"),'id':("student1"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(66)
})
invokeTag('form','g',378,['url':([resource:issueDetailsInstance, action:'save'])],2)
printHtmlPart(67)
invokeTag('render','g',387,['template':("/footer/footer")],-1)
printHtmlPart(68)
})
invokeTag('captureBody','sitemesh',505,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(69)
}
...
public static final long LAST_MODIFIED = 1628925997713L
