...
class gsp_EDUCARE_issueDetailsStudentstudentmagazinereport_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/issueDetailsStudent/studentmagazinereport.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',78,['template':("/header/leftSide"),'model':([activ:[BooksReport:'start active open',issueDetailsStudentManagine:'active']])],-1)
printHtmlPart(8)
...
printHtmlPart(12)
expressionOut.print(c?.magazineId?.magazineName)
printHtmlPart(13)
invokeTag('formatDate','g',136,['date':(c?.issuedate),'type':("date"),'style':("SHORT")],-1)
printHtmlPart(14)
invokeTag('formatDate','g',138,['date':(c?.returndate),'type':("date"),'style':("SHORT")],-1)
printHtmlPart(15)
j++
}
}
...
public static final long LAST_MODIFIED = 1628926004810L
