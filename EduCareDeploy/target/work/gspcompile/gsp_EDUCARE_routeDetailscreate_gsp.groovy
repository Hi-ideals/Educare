...
class gsp_EDUCARE_routeDetailscreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/routeDetails/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',80,['template':("/header/leftSide"),'model':([activ:[TransportManagement:'start active open',RouteDetails:'active']])],-1)
printHtmlPart(8)
...
invokeTag('link','g',94,['class':("list"),'action':("index")],2)
printHtmlPart(12)
...
invokeTag('eachError','g',115,['bean':(routeDetailsInstance),'var':("error")],3)
printHtmlPart(22)
})
invokeTag('hasErrors','g',117,['bean':(routeDetailsInstance)],2)
printHtmlPart(23)
createTagBody(2, {->
printHtmlPart(24)
invokeTag('render','g',131,['template':("form")],-1)
printHtmlPart(25)
invokeTag('submitButton','g',137,['name':("create"),'class':("save btn blue"),'id':("routeDetails"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(26)
})
invokeTag('form','g',139,['url':([resource:routeDetailsInstance, action:'save'])],2)
printHtmlPart(27)
...
public static final long LAST_MODIFIED = 1628926003656L
