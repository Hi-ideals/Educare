...
class gsp_EDUCARE_markscreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/marks/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',65,['template':("/header/leftSide"),'model':([activ:[exams:'start active open',marks:'active']])],-1)
printHtmlPart(8)
...
printHtmlPart(25)
invokeTag('submitButton','g',122,['name':("create"),'class':("save btn blue"),'id':("marks"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(26)
})
invokeTag('form','g',124,['url':([resource:marksInstance, action:'save'])],2)
printHtmlPart(27)
...
public static final long LAST_MODIFIED = 1628925994183L
