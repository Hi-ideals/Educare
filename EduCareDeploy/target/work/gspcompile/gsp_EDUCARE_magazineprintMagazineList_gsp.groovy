...
class gsp_EDUCARE_magazineprintMagazineList_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/magazine/printMagazineList.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(19)
invokeTag('formatBoolean','g',166,['boolean':(magazineInstance.cddvd)],-1)
printHtmlPart(20)
expressionOut.print(fieldValue(bean: magazineInstance, field: "cost"))
printHtmlPart(19)
invokeTag('formatDate','g',174,['date':(magazineInstance.purchasedOn),'type':("date"),'style':("SHORT")],-1)
printHtmlPart(21)
i++
}
}
printHtmlPart(22)
invokeTag('render','g',234,['template':("/footer/footer")],-1)
printHtmlPart(23)
})
invokeTag('captureBody','sitemesh',272,['class':("page-header-fixed page-sidebar-closed-hide-logo page-content-white")],1)
printHtmlPart(24)
}
...
public static final long LAST_MODIFIED = 1628925996567L
