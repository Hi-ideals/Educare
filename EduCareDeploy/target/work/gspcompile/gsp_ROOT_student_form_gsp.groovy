...
class gsp_ROOT_student_form_gsp extends GroovyPage {
...
printHtmlPart(71)
for( _it1828372669 in (rut) ) {
changeItVariable(_it1828372669)
printHtmlPart(72)
...
printHtmlPart(78)
for( _it1419635675 in (dst) ) {
changeItVariable(_it1419635675)
printHtmlPart(72)
expressionOut.print(it?.id)
printHtmlPart(73)
