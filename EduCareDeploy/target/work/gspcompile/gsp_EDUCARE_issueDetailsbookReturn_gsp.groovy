...
class gsp_EDUCARE_issueDetailsbookReturn_gsp extends GroovyPage {
...
printHtmlPart(30)
for( _it685072424 in (studentlist) ) {
changeItVariable(_it685072424)
printHtmlPart(31)
...
printHtmlPart(39)
for( _it113602559 in (com.hiideals.institute.library.Magazine.list()) ) {
changeItVariable(_it113602559)
printHtmlPart(40)
expressionOut.print(it.id)
printHtmlPart(41)
...
printHtmlPart(45)
for( _it1039022700 in (com.hiideals.institute.library.Newspaper.list()) ) {
changeItVariable(_it1039022700)
printHtmlPart(40)
expressionOut.print(it.id)
printHtmlPart(41)
