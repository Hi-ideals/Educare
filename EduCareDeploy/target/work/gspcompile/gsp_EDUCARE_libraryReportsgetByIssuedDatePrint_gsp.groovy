...
class gsp_EDUCARE_libraryReportsgetByIssuedDatePrint_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/libraryReports/getByIssuedDatePrint.gsp" }
public Object run() {
Writer out = getOut()
...
else if(true && (issuedToStudents == null)) {
printHtmlPart(23)
loop:{
int i = 0
for( issuedInstance in (issuedToStaff) ) {
printHtmlPart(17)
expressionOut.print((i % 2) == 0 ? 'even' : 'odd')
printHtmlPart(18)
expressionOut.print(issuedInstance?.staffId?.staffName)
printHtmlPart(19)
expressionOut.print(issuedInstance?.books?.title.toString().replace('[', '').replace(']', ''))
printHtmlPart(20)
expressionOut.print(issuedInstance?.dateOfIssue)
...
public static final long LAST_MODIFIED = 1628925999659L
